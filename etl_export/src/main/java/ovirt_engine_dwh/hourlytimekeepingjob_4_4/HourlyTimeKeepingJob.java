...
package ovirt_engine_dwh.hourlytimekeepingjob_4_4;
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				if (context.dwhAggregationDebug.equals("true")) {
					System.out.print(TalendDate.formatDate(
							...
							+ " Aggregation to Hourly ended.\n");
				}
				if (context.continueAgg == 0) {
					Thread.sleep((Long) TalendDate.diffDate(TalendDate.addDate(
							RoutineHistoryETL.startOfHour(context.runTime), 1,
							"HH"), context.runTime, "SSS"));
				} else {
					Thread.sleep(5000);
				}
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				try {
					...
					while (rs_tJDBCInput_4.next()) {
						...
						if (row11.key != null) {
							key_tContextLoad_4 = row11.key;
						}
						String value_tContextLoad_4 = null;
						if (row11.value != null) {
							value_tContextLoad_4 = row11.value;
						}
				...
				if (TalendDate.diffDate(context.runTime, context.lastHourAggr,
						"HH") >= 2) {
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				ovirt_engine_dwh.aggregationtohourly_4_4.AggregationToHourly childJob_tRunJob_1 = new ovirt_engine_dwh.aggregationtohourly_4_4.AggregationToHourly();
				// pass DataSources
	...
	public void tJDBCInput_2Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String dbquery_tJDBCInput_2 = "SELECT 'continueAgg', '1'\nFROM history_configuration\nWHERE var_name = 'lastHourAggr'\nAND var_datetime < '"
				...
				resumeUtil
						.addLog("USER_DEF_LOG",
								...
								TalendDate.getDate("YYYY-MM-DD hh:mm:ss")
										+ "| ETL service aggregation to hourly tables has encountered an error. lastHourAgg value ="
										+ context.lastHourAggr
										+ " and runTime = "
										+ context.runTime
					...
					if (AggregationsDebug != null) {
						...
						if (row5 != null) {
							...
							if (row5.job_repository_id != null) { //
								...
								strBuffer_tLogRow_1.append(String
										.valueOf(row5.job_repository_id));
		...
		try {
			...
			java.io.InputStream inContext = HourlyTimeKeepingJob.class
					.getClassLoader().getResourceAsStream(
							"ovirt_engine_dwh/hourlytimekeepingjob_4_4/contexts/"
...
/************************************************************************************************
 * 240059 characters generated by Talend Open Studio for Data Integration on the
