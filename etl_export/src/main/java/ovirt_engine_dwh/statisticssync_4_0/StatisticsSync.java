				...
				try {
					...
					while (rs_tJDBCInput_2.next()) {
						...
						if (colQtyInRs_tJDBCInput_2 < 2) {
							...
							row9.datacenter_join_id = routines.system.JDBCUtil
				...
				try {
					...
					while (rs_tJDBCInput_1.next()) {
						...
						if (colQtyInRs_tJDBCInput_1 < 2) {
							...
							row41.datacenter_join_id = routines.system.JDBCUtil
...
/************************************************************************************************
 * 487492 characters generated by Talend Open Studio for Data Integration on the
