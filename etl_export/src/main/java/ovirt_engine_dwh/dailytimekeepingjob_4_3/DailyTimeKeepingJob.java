...
package ovirt_engine_dwh.dailytimekeepingjob_4_3;
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				ovirt_engine_dwh.aggregationtodaily_4_3.AggregationToDaily childJob_tRunJob_1 = new ovirt_engine_dwh.aggregationtodaily_4_3.AggregationToDaily();
				// pass DataSources
		...
		try {
			...
			java.io.InputStream inContext = DailyTimeKeepingJob.class
					.getClassLoader().getResourceAsStream(
							"ovirt_engine_dwh/dailytimekeepingjob_4_3/contexts/"
...
/************************************************************************************************
 * 240306 characters generated by Talend Open Studio for Data Integration on the
 * July 25, 2019 3:49:11 PM IDT
 ************************************************************************************************/
