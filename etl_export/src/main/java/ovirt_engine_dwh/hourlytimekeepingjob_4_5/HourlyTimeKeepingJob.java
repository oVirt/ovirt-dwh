...
package ovirt_engine_dwh.hourlytimekeepingjob_4_5;
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_Q9_uQNI6EeCOk4qSIFFDtw", "4.5");
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(HourlyTimeKeepingJob.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_OVIRT_ENGINE_DWH_HourlyTimeKeepingJob.length) {
				if(length < 1024 && commonByteArray_OVIRT_ENGINE_DWH_HourlyTimeKeepingJob.length == 0) {
			...
			dis.readFully(commonByteArray_OVIRT_ENGINE_DWH_HourlyTimeKeepingJob, 0, length);
			strReturn = new String(commonByteArray_OVIRT_ENGINE_DWH_HourlyTimeKeepingJob, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_OVIRT_ENGINE_DWH_HourlyTimeKeepingJob, 0, length);
			strReturn = new String(commonByteArray_OVIRT_ENGINE_DWH_HourlyTimeKeepingJob, 0, length, utf8Charset);
		}
		return strReturn;
	}
 		                    ...
 		                    class SchemaSettingTool_tJDBCInput_3_1_fisrt {
 		                    		...
 		                    		String getSchemaValue() {
 		                    						...
 		                    						StringBuilder s = new StringBuilder();
     		                    						...
     		                    						a("\"name\":\"value\",\"type\":[{\"type\":\"long\",\"java-class\":\"java.util.Date\"},\"null\"],\"di.table.comment\":\"\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"value\",\"di.column.talendType\":\"id_Date\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"dd-MM-yyyy\",\"talend.field.length\":\"35\",\"di.column.relationshipType\":\"\",\"di.column.originalLength\":\"0\",\"di.table.label\":\"value\",\"talend.field.precision\":\"6\",\"di.column.relatedEntity\":\"\"}],\"di.table.name\":\"tJDBCInput_3\",\"di.table.label\":\"tJDBCInput_3\"}",s);
...
if (context.dwhAggregationDebug.equals("true")) {System.out.print(TalendDate.formatDate("yyyy-MM-dd HH:mm:ss", context.runTime)  + " Aggregation to Hourly ended.\n");}
if (context.continueAgg == 0) {
    Thread.sleep((Long)TalendDate.diffDate(TalendDate.addDate(RoutineHistoryETL.startOfHour(context.runTime),1,"HH"),context.runTime,"SSS"));
} else {
    Thread.sleep(5000);
}
 		                    ...
 		                    class SchemaSettingTool_tJDBCInput_4_1_fisrt {
 		                    		...
 		                    		String getSchemaValue() {
 		                    						...
 		                    						StringBuilder s = new StringBuilder();
     		                    						...
     		                    						a("\"name\":\"value\",\"type\":\"string\",\"di.table.comment\":\"\",\"talend.field.dbType\":\"INT4\",\"talend.field.dbColumnName\":\"value\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"255\",\"di.column.relationshipType\":\"\",\"di.column.originalLength\":\"0\",\"di.table.label\":\"value\",\"talend.field.precision\":\"0\",\"di.column.relatedEntity\":\"\"}],\"di.table.name\":\"tJDBCInput_4\",\"di.table.label\":\"vm_disk_hourly_history\"}",s);
    ...
    if (sourceOrSink_tJDBCInput_4 instanceof org.talend.components.api.component.runtime.Source) {
        ...
        outgoingEnforcer_tJDBCInput_4.setWrapped(factory_tJDBCInput_4.convertToAvro(data_tJDBCInput_4));
                Object columnValue_0_tJDBCInput_4 = outgoingEnforcer_tJDBCInput_4.get(0);
                        row11.key = (String) (columnValue_0_tJDBCInput_4);
                Object columnValue_1_tJDBCInput_4 = outgoingEnforcer_tJDBCInput_4.get(1);
                        row11.value = (String) (columnValue_1_tJDBCInput_4);
...
end_Hash.put("tJDBCInput_4", System.currentTimeMillis());
   			...
   			if (TalendDate.diffDate(context.runTime, context.lastHourAggr, "HH") >= 2) {
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		ovirt_engine_dwh.aggregationtohourly_4_5.AggregationToHourly childJob_tRunJob_1 = new ovirt_engine_dwh.aggregationtohourly_4_5.AggregationToHourly();
	    // pass DataSources
 		                    ...
 		                    class SchemaSettingTool_tJDBCOutput_2_1_fisrt {
 		                    		...
 		                    		String getSchemaValue() {
 		                    						...
 		                    						StringBuilder s = new StringBuilder();
     		                    						...
     		                    						a("\"name\":\"var_value\",\"type\":\"string\",\"di.table.comment\":\"\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"var_value\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.column.originalLength\":\"0\",\"di.table.label\":\"var_value\",\"di.column.relatedEntity\":\"\"}],\"di.table.name\":\"tJDBCOutput_2\",\"di.table.label\":\"tJDBCOutput_2\"}",s);
        ...
        if (incomingEnforcer_tJDBCOutput_2 != null) {
            incomingEnforcer_tJDBCOutput_2.createNewRecord();
                ...
                if (incomingEnforcer_tJDBCOutput_2 != null && incomingEnforcer_tJDBCOutput_2.getRuntimeSchema().getField("var_name") != null){
                    incomingEnforcer_tJDBCOutput_2.put("var_name", row7.var_name);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tJDBCOutput_2 != null && incomingEnforcer_tJDBCOutput_2.getRuntimeSchema().getField("var_value") != null){
                    incomingEnforcer_tJDBCOutput_2.put("var_value", row7.var_value);
                }
        ...
        if (incomingEnforcer_tJDBCOutput_3 != null) {
            incomingEnforcer_tJDBCOutput_3.createNewRecord();
                ...
                if (incomingEnforcer_tJDBCOutput_3 != null && incomingEnforcer_tJDBCOutput_3.getRuntimeSchema().getField("var_name") != null){
                    incomingEnforcer_tJDBCOutput_3.put("var_name", row4.var_name);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tJDBCOutput_3 != null && incomingEnforcer_tJDBCOutput_3.getRuntimeSchema().getField("var_value") != null){
                    incomingEnforcer_tJDBCOutput_3.put("var_value", row4.var_value);
                }
...
org.talend.components.jdbc.tjdbcinput.TJDBCInputProperties props_tJDBCInput_2 =
        (org.talend.components.jdbc.tjdbcinput.TJDBCInputProperties) def_tJDBCInput_2.createRuntimeProperties();
 		                    ...
 		                    "SELECT 'continueAgg', '1'\nFROM history_configuration\nWHERE var_name = 'lastHourAggr'\nAND var_datetime < '"+new SimpleDateFormat("yyyy-MM-dd HH:mm:ss.SSSSSSZ").format(TalendDate.addDate(RoutineHistoryETL.startOfHour(context.runTime), -1,"HH"))+"'\n");
...
try {
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_1", "", Thread.currentThread().getId() + "", "ERROR","",TalendDate.getDate("YYYY-MM-DD hh:mm:ss") + "| ETL service aggregation to hourly tables has encountered an error. lastHourAgg value ="  +  context.lastHourAggr + " and runTime = " + context.runTime + " .Please consult the service log for more details.","", "");
	tLogCatcher_1.addMessage("tWarn", "tWarn_1", 5, TalendDate.getDate("YYYY-MM-DD hh:mm:ss") + "| ETL service aggregation to hourly tables has encountered an error. lastHourAgg value ="  +  context.lastHourAggr + " and runTime = " + context.runTime + " .Please consult the service log for more details.", 42);
	tLogCatcher_1Process(globalMap);
	talendLogs_LOGS.addMessage("tWarn", "tWarn_1", 5, TalendDate.getDate("YYYY-MM-DD hh:mm:ss") + "| ETL service aggregation to hourly tables has encountered an error. lastHourAgg value ="  +  context.lastHourAggr + " and runTime = " + context.runTime + " .Please consult the service log for more details.", 42);
	talendLogs_LOGSProcess(globalMap);
	globalMap.put("tWarn_1_WARN_MESSAGES", TalendDate.getDate("YYYY-MM-DD hh:mm:ss") + "| ETL service aggregation to hourly tables has encountered an error. lastHourAgg value ="  +  context.lastHourAggr + " and runTime = " + context.runTime + " .Please consult the service log for more details."); 
...
context.dwhAggregationDebug.equals("true")
    ...
    if (ope_tFilterRow_1.getMatchFlag()) {
              if(row5 == null){ 
               ...
               row5.moment = AggregationsDebug.moment;
               row5.pid = AggregationsDebug.pid;
               row5.father_pid = AggregationsDebug.father_pid;
               row5.root_pid = AggregationsDebug.root_pid;
               row5.system_pid = AggregationsDebug.system_pid;
               row5.project = AggregationsDebug.project;
               row5.job = AggregationsDebug.job;
               row5.job_repository_id = AggregationsDebug.job_repository_id;
               row5.job_version = AggregationsDebug.job_version;
               row5.context = AggregationsDebug.context;
               row5.origin = AggregationsDebug.origin;
               row5.message_type = AggregationsDebug.message_type;
               row5.message = AggregationsDebug.message;
               row5.duration = AggregationsDebug.duration;    
...
///////////////////////		
				...
				strBuffer_tLogRow_1.append(
				                String.valueOf(row5.message_type)							
				);
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = HourlyTimeKeepingJob.class.getClassLoader().getResourceAsStream("ovirt_engine_dwh/hourlytimekeepingjob_4_5/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = HourlyTimeKeepingJob.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : HourlyTimeKeepingJob");
        }
...
/************************************************************************************************
 *     498794 characters generated by Talend Open Studio for Data Integration 
 *     on the January 11, 2022 at 6:57:34 PM IST
 ************************************************************************************************/