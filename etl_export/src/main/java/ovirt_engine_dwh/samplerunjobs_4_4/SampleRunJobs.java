...
package ovirt_engine_dwh.samplerunjobs_4_4;
	...
	public void tRunJob_4Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				ovirt_engine_dwh.osenumupdate_4_4.OsEnumUpdate childJob_tRunJob_4 = new ovirt_engine_dwh.osenumupdate_4_4.OsEnumUpdate();
				// pass DataSources
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				ovirt_engine_dwh.configurationsync_4_4.ConfigurationSync childJob_tRunJob_1 = new ovirt_engine_dwh.configurationsync_4_4.ConfigurationSync();
				// pass DataSources
	...
	public void tRunJob_6Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				ovirt_engine_dwh.hostconfigcheck_4_4.HostConfigCheck childJob_tRunJob_6 = new ovirt_engine_dwh.hostconfigcheck_4_4.HostConfigCheck();
				// pass DataSources
	...
	public void tRunJob_5Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				ovirt_engine_dwh.statisticssync_4_4.StatisticsSync childJob_tRunJob_5 = new ovirt_engine_dwh.statisticssync_4_4.StatisticsSync();
				// pass DataSources
		...
		try {
			...
			java.io.InputStream inContext = SampleRunJobs.class
					.getClassLoader().getResourceAsStream(
							"ovirt_engine_dwh/samplerunjobs_4_4/contexts/"
...
/************************************************************************************************
 * 82780 characters generated by Talend Open Studio for Data Integration on the
