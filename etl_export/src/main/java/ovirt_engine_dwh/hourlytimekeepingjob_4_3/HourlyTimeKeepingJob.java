...
package ovirt_engine_dwh.hourlytimekeepingjob_4_3;
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				ovirt_engine_dwh.aggregationtohourly_4_3.AggregationToHourly childJob_tRunJob_1 = new ovirt_engine_dwh.aggregationtohourly_4_3.AggregationToHourly();
				// pass DataSources
		...
		try {
			...
			java.io.InputStream inContext = HourlyTimeKeepingJob.class
					.getClassLoader().getResourceAsStream(
							"ovirt_engine_dwh/hourlytimekeepingjob_4_3/contexts/"
