...
package ovirt_engine_dwh.sampletimekeepingjob_4_4;
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				ovirt_engine_dwh.samplerunjobs_4_4.SampleRunJobs childJob_tRunJob_1 = new ovirt_engine_dwh.samplerunjobs_4_4.SampleRunJobs();
				// pass DataSources
		...
		try {
			...
			java.io.InputStream inContext = SampleTimeKeepingJob.class
					.getClassLoader().getResourceAsStream(
							"ovirt_engine_dwh/sampletimekeepingjob_4_4/contexts/"
