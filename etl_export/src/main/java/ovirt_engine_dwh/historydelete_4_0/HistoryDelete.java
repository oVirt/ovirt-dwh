...
package ovirt_engine_dwh.historydelete_4_0;
					...
					while (rs_tJDBCInput_1.next()) {
						...
						if (colQtyInRs_tJDBCInput_1 < 1) {
							...
							if (rs_tJDBCInput_1.getObject(1) != null) {
								row13.history_id = rs_tJDBCInput_1.getLong(1);
							} else {
								throw new RuntimeException(
	...
	public void tJDBCInput_6Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String dbquery_tJDBCInput_6 = "SELECT history_id\nFROM datacenter_hourly_history\nWHERE history_datetime < '"
						+ new SimpleDateFormat("yyyy-MM-dd HH:mm:ss.SSSSSSZ")
								.format(TalendDate.addDate(context.runTime,
					...
					while (rs_tJDBCInput_6.next()) {
						...
						if (colQtyInRs_tJDBCInput_6 < 1) {
							...
							if (rs_tJDBCInput_6.getObject(1) != null) {
								row6.history_id = rs_tJDBCInput_6.getLong(1);
							} else {
								throw new RuntimeException(
										"Null value in non-Nullable column");
							}
		...
		try {
			...
			java.io.InputStream inContext = HistoryDelete.class
					.getClassLoader().getResourceAsStream(
							"ovirt_engine_dwh/historydelete_4_0/contexts/"
