	...
	public void tJDBCClose_2Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || globalResumeTicket) {
				resumeUtil
						.addLog("CHECKPOINT",
								"CONNECTION:SUBJOB_OK:tJDBCClose_2:OnSubjobOk",
								"", Thread.currentThread().getId() + "", "",
								"", "", "", "");
			}
		...
		try {
			...
			java.io.InputStream inContext = DailyTimeKeepingJob.class
					.getClassLoader().getResourceAsStream(
							"ovirt_engine_dwh/dailytimekeepingjob_4_5/contexts/"
...
/************************************************************************************************
 * 240107 characters generated by Talend Open Studio for Data Integration on the
 * July 25, 2019 3:09:53 PM IDT
 ************************************************************************************************/
