...
package ovirt_engine_dwh.samplerunjobs_3_6;
	...
	public void tRunJob_4Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				ovirt_engine_dwh.osenumupdate_3_6.OsEnumUpdate childJob_tRunJob_4 = new ovirt_engine_dwh.osenumupdate_3_6.OsEnumUpdate();
				// pass DataSources
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				ovirt_engine_dwh.configurationsync_3_6.ConfigurationSync childJob_tRunJob_1 = new ovirt_engine_dwh.configurationsync_3_6.ConfigurationSync();
				// pass DataSources
	...
	public void tRunJob_6Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				ovirt_engine_dwh.hostconfigcheck_3_6.HostConfigCheck childJob_tRunJob_6 = new ovirt_engine_dwh.hostconfigcheck_3_6.HostConfigCheck();
				// pass DataSources
	...
	public void tRunJob_5Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				ovirt_engine_dwh.statisticssync_3_6.StatisticsSync childJob_tRunJob_5 = new ovirt_engine_dwh.statisticssync_3_6.StatisticsSync();
				// pass DataSources
		...
		try {
			...
			java.io.InputStream inContext = SampleRunJobs.class
					.getClassLoader().getResourceAsStream(
							"ovirt_engine_dwh/samplerunjobs_3_6/contexts/"
