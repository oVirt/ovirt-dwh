...
package ovirt_engine_dwh.validateinstallation_3_6;
					...
					while (rs_tJDBCInput_1.next()) {
						...
						if (colQtyInRs_tJDBCInput_1 < column_index_tJDBCInput_1) {
							...
							if (tmpContent_tJDBCInput_1 != null) {
								row10.key = tmpContent_tJDBCInput_1;
							} else {
								row10.key = null;
							}
						...
						if (colQtyInRs_tJDBCInput_1 < column_index_tJDBCInput_1) {
							...
							tmpContent_tJDBCInput_1 = rs_tJDBCInput_1
									.getString(column_index_tJDBCInput_1);
							if (tmpContent_tJDBCInput_1 != null) {
								row10.value = tmpContent_tJDBCInput_1;
							} else {
								row10.value = null;
							}
					...
					while (rs_tJDBCInput_2.next()) {
						...
						if (colQtyInRs_tJDBCInput_2 < column_index_tJDBCInput_2) {
							...
							if (tmpContent_tJDBCInput_2 != null) {
								row11.key = tmpContent_tJDBCInput_2;
							} else {
								row11.key = null;
							}
						...
						if (colQtyInRs_tJDBCInput_2 < column_index_tJDBCInput_2) {
							...
							tmpContent_tJDBCInput_2 = rs_tJDBCInput_2
									.getString(column_index_tJDBCInput_2);
							if (tmpContent_tJDBCInput_2 != null) {
								row11.value = tmpContent_tJDBCInput_2;
							} else {
								row11.value = null;
							}
		...
		try {
			...
			java.io.InputStream inContext = ValidateInstallation.class
					.getClassLoader().getResourceAsStream(
							"ovirt_engine_dwh/validateinstallation_3_6/contexts/"
...
/************************************************************************************************
 * 116198 characters generated by Talend Open Studio for Data Integration on the
 * September 4, 2014 4:54:44 PM IDT
 ************************************************************************************************/
