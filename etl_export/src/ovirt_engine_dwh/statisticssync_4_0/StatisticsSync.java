	...
	public void tJDBCInput_1Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String dbquery_tJDBCInput_1 = "SELECT history_id, upper(cast(datacenter_id as char(36))) as datacenter_join_id\nFROM  v4_0_latest_configuration_datacenters";
		...
		try {
			...
			java.io.InputStream inContext = StatisticsSync.class
					.getClassLoader().getResourceAsStream(
							"ovirt_engine_dwh/statisticssync_4_0/contexts/"
