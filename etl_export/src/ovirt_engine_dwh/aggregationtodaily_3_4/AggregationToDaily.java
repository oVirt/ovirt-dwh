...
package ovirt_engine_dwh.aggregationtodaily_3_4;
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				class AggOperationStruct_tAggregateRow_8 { // G_OutBegin_AggR_100
					...
					Integer vm_configuration_version_last;
					Integer current_host_configuration_version_last;
					Short user_logged_in_to_guest_max;
				...
				for (AggOperationStruct_tAggregateRow_8 aggregated_row_tAggregateRow_8 : values_tAggregateRow_8) { // G_AggR_600
					...
					{ // start of Var scope
						...
						complete_aggregate_users_tmp.user_logged_in_to_guest = row14.user_logged_in_to_guest > 0;
		...
		try {
			...
			java.io.InputStream inContext = AggregationToDaily.class
					.getClassLoader().getResourceAsStream(
							"ovirt_engine_dwh/aggregationtodaily_3_4/contexts/"
...
/************************************************************************************************
 * 748765 characters generated by Talend Open Studio for Data Integration on the
 * January 21, 2014 3:54:34 PM IST
 ************************************************************************************************/
