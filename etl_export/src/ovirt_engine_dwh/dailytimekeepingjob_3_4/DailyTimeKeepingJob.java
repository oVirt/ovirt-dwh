...
package ovirt_engine_dwh.dailytimekeepingjob_3_4;
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				ovirt_engine_dwh.aggregationtodaily_3_4.AggregationToDaily childJob_tRunJob_1 = new ovirt_engine_dwh.aggregationtodaily_3_4.AggregationToDaily();
				// pass DataSources
		...
		try {
			...
			java.io.InputStream inContext = DailyTimeKeepingJob.class
					.getClassLoader().getResourceAsStream(
							"ovirt_engine_dwh/dailytimekeepingjob_3_4/contexts/"
...
/************************************************************************************************
 * 107804 characters generated by Talend Open Studio for Data Integration on the
 * June 23, 2013 12:08:18 PM IDT
 ************************************************************************************************/
