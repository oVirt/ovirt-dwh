...
package ovirt_engine_dwh.dailytimekeepingjob_3_6;
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				if (context.dwhAggregationDebug.equals("true")) {
					System.out.print(TalendDate.formatDate(
							...
							+ " Aggregation to Daily ended.\n");
				}
				if (context.continueAgg == 0) {
					Thread.sleep((Long) TalendDate.diffDate(TalendDate.addDate(
							RoutineHistoryETL.startOfDay(context.runTime), 1,
							"dd"), context.runTime, "SSS"));
				} else {
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				ovirt_engine_dwh.aggregationtodaily_3_6.AggregationToDaily childJob_tRunJob_1 = new ovirt_engine_dwh.aggregationtodaily_3_6.AggregationToDaily();
				// pass DataSources
	...
	public void tJDBCInput_2Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String dbquery_tJDBCInput_2 = "SELECT DISTINCT 'continueAgg', '1'\nFROM history_configuration\nWHERE var_name = 'lastDayAggr'\n	AND var_datetime < '"
						+ new SimpleDateFormat("yyyy-MM-dd HH:mm:ss.SSSSSSZ")
								.format(TalendDate.addDate(RoutineHistoryETL
										.startOfDay(context.runTime), -1, "dd"))
						+ "'\n	AND\n		CASE\n			WHEN\n				var_datetime = '"
						+ new SimpleDateFormat("yyyy-MM-dd HH:mm:ss.SSSSSSZ")
								.format(RoutineHistoryETL
										.startOfDay(context.lastHourAggr))
		...
		try {
			...
			java.io.InputStream inContext = DailyTimeKeepingJob.class
					.getClassLoader().getResourceAsStream(
							"ovirt_engine_dwh/dailytimekeepingjob_3_6/contexts/"
...
/************************************************************************************************
 * 235185 characters generated by Talend Open Studio for Data Integration on the
 * March 8, 2016 9:17:36 PM IST
 ************************************************************************************************/
