...
package ovirt_engine_dwh.samplerunjobs_3_5;
	...
	public void tRunJob_4Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				ovirt_engine_dwh.osenumupdate_3_5.OsEnumUpdate childJob_tRunJob_4 = new ovirt_engine_dwh.osenumupdate_3_5.OsEnumUpdate();
				// pass DataSources
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				ovirt_engine_dwh.configurationsync_3_5.ConfigurationSync childJob_tRunJob_1 = new ovirt_engine_dwh.configurationsync_3_5.ConfigurationSync();
				// pass DataSources
	...
	public void tRunJob_6Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				ovirt_engine_dwh.hostconfigcheck_3_5.HostConfigCheck childJob_tRunJob_6 = new ovirt_engine_dwh.hostconfigcheck_3_5.HostConfigCheck();
				// pass DataSources
	...
	public void tRunJob_5Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				ovirt_engine_dwh.statisticssync_3_5.StatisticsSync childJob_tRunJob_5 = new ovirt_engine_dwh.statisticssync_3_5.StatisticsSync();
				// pass DataSources
		...
		try {
			...
			java.io.InputStream inContext = SampleRunJobs.class
					.getClassLoader().getResourceAsStream(
							"ovirt_engine_dwh/samplerunjobs_3_5/contexts/"
