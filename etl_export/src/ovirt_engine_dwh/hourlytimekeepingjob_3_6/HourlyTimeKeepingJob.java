...
package ovirt_engine_dwh.hourlytimekeepingjob_3_6;
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				ovirt_engine_dwh.aggregationtohourly_3_6.AggregationToHourly childJob_tRunJob_1 = new ovirt_engine_dwh.aggregationtohourly_3_6.AggregationToHourly();
				// pass DataSources
		...
		try {
			...
			java.io.InputStream inContext = HourlyTimeKeepingJob.class
					.getClassLoader().getResourceAsStream(
							"ovirt_engine_dwh/hourlytimekeepingjob_3_6/contexts/"
...
/************************************************************************************************
 * 220199 characters generated by Talend Open Studio for Data Integration on the
 * March 8, 2016 9:17:35 PM IST
 ************************************************************************************************/
