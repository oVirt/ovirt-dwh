...
package ovirt_engine_dwh.deletetimekeepingjob_3_6;
	...
	public void tRunJob_2Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				ovirt_engine_dwh.historydelete_3_6.HistoryDelete childJob_tRunJob_2 = new ovirt_engine_dwh.historydelete_3_6.HistoryDelete();
				// pass DataSources
		...
		try {
			...
			java.io.InputStream inContext = DeleteTimeKeepingJob.class
					.getClassLoader().getResourceAsStream(
							"ovirt_engine_dwh/deletetimekeepingjob_3_6/contexts/"
...
/************************************************************************************************
 * 266796 characters generated by Talend Open Studio for Data Integration on the
