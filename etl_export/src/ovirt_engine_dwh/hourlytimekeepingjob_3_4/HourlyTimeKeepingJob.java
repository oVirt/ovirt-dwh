...
package ovirt_engine_dwh.hourlytimekeepingjob_3_4;
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				if (context.continueAgg == 0) {
					if (((Long) globalMap.get("tChronometerStop_1_DURATION")) < 3600000L) {
						Thread.sleep(3600000L - ((Long) globalMap
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				ovirt_engine_dwh.aggregationtohourly_3_4.AggregationToHourly childJob_tRunJob_1 = new ovirt_engine_dwh.aggregationtohourly_3_4.AggregationToHourly();
				// pass DataSources
		...
		try {
			...
			java.io.InputStream inContext = HourlyTimeKeepingJob.class
					.getClassLoader().getResourceAsStream(
							"ovirt_engine_dwh/hourlytimekeepingjob_3_4/contexts/"
...
/************************************************************************************************
 * 162139 characters generated by Talend Open Studio for Data Integration on the
 * April 29, 2014 12:06:53 PM IDT
 ************************************************************************************************/
