...
package ovirt_engine_dwh.aggregationtohourly_4_0;
...
public class AggregationToHourly implements TalendJob {
					...
					while (rs_tJDBCInput_1.next()) {
						...
						if (colQtyInRs_tJDBCInput_1 < 1) {
							...
							if (rs_tJDBCInput_1.getObject(1) != null) {
								row1.history_id = rs_tJDBCInput_1.getLong(1);
							} else {
								throw new RuntimeException(
				...
				try {
					...
					while (rs_tJDBCInput_4.next()) {
						...
						if (colQtyInRs_tJDBCInput_4 < 17) {
							...
							if (rs_tJDBCInput_4.getObject(17) != null) {
	...
	public static class disk_usage_aggregateStruct implements
			routines.system.IPersistableRow<disk_usage_aggregateStruct> {
		final static byte[] commonByteArrayLock_OVIRT_ENGINE_DWH_AggregationToHourly = new byte[0];
		static byte[] commonByteArray_OVIRT_ENGINE_DWH_AggregationToHourly = new byte[0];
		 ...
		 * Compare keys
		 */
		public int compareTo(disk_usage_aggregateStruct other) {
	...
	public void tJDBCInput_9Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				disk_usage_aggregateStruct disk_usage_aggregate = new disk_usage_aggregateStruct();
				...
				// ###############################
				// # Outputs initialization
				disk_usage_aggregateStruct disk_usage_aggregate_tmp = new disk_usage_aggregateStruct();
				// ###############################
				...
				try {
					...
					while (rs_tJDBCInput_9.next()) {
						...
						{ // start of Var scope
							...
							disk_usage_aggregate = null;

							// # Output table : 'disk_usage_aggregate'
							disk_usage_aggregate_tmp.history_datetime = RoutineHistoryETL
									.startOfHour(row12.history_datetime);
							disk_usage_aggregate_tmp.vm_id = row12.vm_id;
							disk_usage_aggregate_tmp.disks_usage = row12.disks_usage;
							disk_usage_aggregate = disk_usage_aggregate_tmp;
							// ###############################
						 ...
						 * [tMap_6 main ] stop
						 */
						// Start of branch "disk_usage_aggregate"
						if (disk_usage_aggregate != null) {
							...
							operation_finder_tAggregateRow_9.history_datetime = disk_usage_aggregate.history_datetime;
							operation_finder_tAggregateRow_9.vm_id = disk_usage_aggregate.vm_id;
							...
							if (disk_usage_aggregate.disks_usage != null) { // G_OutMain_AggR_546

								if (isFirstAdd_tAggregateRow_9
										|| operation_result_tAggregateRow_9.disks_usage_first == null) {
									operation_result_tAggregateRow_9.disks_usage_first = disk_usage_aggregate.disks_usage;
								}
						...
						} // End of branch "disk_usage_aggregate"
		...
		try {
			...
			java.io.InputStream inContext = AggregationToHourly.class
					.getClassLoader().getResourceAsStream(
							"ovirt_engine_dwh/aggregationtohourly_4_0/contexts/"
...
/************************************************************************************************
 * 786436 characters generated by Talend Open Studio for Data Integration on the
