...
CREATE OR REPLACE VIEW v3_5_enum_translator
 AS
SELECT
...
CREATE OR REPLACE VIEW v3_5_configuration_history_datacenters
 AS
SELECT
...
CREATE OR REPLACE VIEW v3_5_latest_configuration_datacenters
 AS
SELECT
      history_id as history_id,
      datacenter_id as datacenter_id,
...
CREATE OR REPLACE VIEW v3_5_statistics_datacenters_resources_usage_samples
 AS
SELECT
      history_id as history_id,
...
CREATE OR REPLACE VIEW v3_5_statistics_datacenters_resources_usage_hourly
 AS
SELECT
      history_id as history_id,
      history_datetime as history_datetime,
...
CREATE OR REPLACE VIEW v3_5_statistics_datacenters_resources_usage_daily
 AS
SELECT
      history_id as history_id,
      history_datetime as history_datetime,
...
CREATE OR REPLACE VIEW v3_5_map_history_datacenters_storage_domains
 AS
SELECT
    history_id as history_id,
...
CREATE OR REPLACE VIEW v3_5_latest_map_datacenters_storage_domains
 AS
SELECT
    history_id as history_id,
    storage_domain_id as storage_domain_id,
...
CREATE OR REPLACE VIEW v3_5_configuration_history_storage_domains
 AS
SELECT
      history_id as history_id,
      storage_domain_id as storage_domain_id,
...
CREATE OR REPLACE VIEW v3_5_latest_configuration_storage_domains
 AS
SELECT
      history_id as history_id,
      storage_domain_id as storage_domain_id,
...
CREATE OR REPLACE VIEW v3_5_statistics_storage_domains_resources_usage_samples
 AS
SELECT
      history_id as history_id,
      history_datetime as history_datetime,
...
CREATE OR REPLACE VIEW v3_5_statistics_storage_domains_resources_usage_hourly
 AS
SELECT
      history_id as history_id,
      history_datetime as history_datetime,
...
CREATE OR REPLACE VIEW v3_5_statistics_storage_domains_resources_usage_daily
 AS
SELECT
      history_id as history_id,
      history_datetime as history_datetime,
...
CREATE OR REPLACE VIEW v3_5_configuration_history_clusters
 AS
SELECT
      history_id as history_id,
...
CREATE OR REPLACE VIEW v3_5_latest_configuration_clusters
 AS
SELECT
      history_id as history_id,
      cluster_id as cluster_id,
...
CREATE OR REPLACE VIEW v3_5_configuration_history_hosts
 AS
SELECT
      history_id as history_id,
      host_id as host_id,
...
CREATE OR REPLACE VIEW v3_5_latest_configuration_hosts
 AS
SELECT
      history_id as history_id,
      host_id as host_id,
...
CREATE OR REPLACE VIEW v3_5_statistics_hosts_resources_usage_samples
 AS
SELECT
      history_id as history_id,
      history_datetime as history_datetime,
...
CREATE OR REPLACE VIEW v3_5_statistics_hosts_resources_usage_hourly
 AS
SELECT
      history_id as history_id,
      history_datetime as history_datetime,
...
CREATE OR REPLACE VIEW v3_5_statistics_hosts_resources_usage_daily
 AS
SELECT
      history_id as history_id,
      history_datetime as history_datetime,
...
CREATE OR REPLACE VIEW v3_5_configuration_history_hosts_interfaces
 AS
SELECT
      history_id as history_id,
...
CREATE OR REPLACE VIEW v3_5_latest_configuration_hosts_interfaces
 AS
SELECT
      history_id as history_id,
      host_interface_id as host_interface_id,
...
CREATE OR REPLACE VIEW v3_5_statistics_hosts_interfaces_resources_usage_samples
 AS
SELECT
      history_id as history_id,
      history_datetime as history_datetime,
...
CREATE OR REPLACE VIEW v3_5_statistics_hosts_interfaces_resources_usage_hourly
 AS
SELECT
      history_id as history_id,
      history_datetime as history_datetime,
...
CREATE OR REPLACE VIEW v3_5_statistics_hosts_interfaces_resources_usage_daily
 AS
...
CREATE OR REPLACE VIEW v3_5_configuration_history_vms
 AS
SELECT
      history_id as history_id,
      vm_id as vm_id,
...
CREATE OR REPLACE VIEW v3_5_latest_configuration_vms
 AS
SELECT
      history_id as history_id,
      vm_id as vm_id,
...
CREATE OR REPLACE VIEW v3_5_statistics_vms_resources_usage_samples
 AS
SELECT
...
CREATE OR REPLACE VIEW v3_5_statistics_vms_resources_usage_hourly
 AS
SELECT
    a.history_id as history_id,
    a.history_datetime as history_datetime,
...
CREATE OR REPLACE VIEW v3_5_statistics_vms_resources_usage_daily
 AS
SELECT
    a.history_id as history_id,
    a.history_datetime as history_datetime,
...
CREATE OR REPLACE VIEW v3_5_statistics_vms_users_usage_hourly
 AS
SELECT history_id,
       history_datetime,
       user_id,
...
CREATE OR REPLACE VIEW v3_5_statistics_vms_users_usage_daily
 AS
SELECT history_id,
       history_datetime,
       user_id,
...
CREATE OR REPLACE VIEW v3_5_configuration_history_vms_interfaces
 AS
SELECT
      history_id as history_id,
...
CREATE OR REPLACE VIEW v3_5_latest_configuration_vms_interfaces
 AS
SELECT
      history_id as history_id,
      vm_interface_id as vm_interface_id,
...
CREATE OR REPLACE VIEW v3_5_statistics_vms_interfaces_resources_usage_samples
 AS
...
CREATE OR REPLACE VIEW v3_5_statistics_vms_interfaces_resources_usage_hourly
 AS
...
CREATE OR REPLACE VIEW v3_5_statistics_vms_interfaces_resources_usage_daily
 AS
...
CREATE OR REPLACE VIEW v3_5_configuration_history_vms_disks
 AS
SELECT
    history_id as history_id,
...
CREATE OR REPLACE VIEW v3_5_latest_configuration_vms_disks
 AS
SELECT
    history_id as history_id,
    vm_disk_id as vm_disk_id,
...
CREATE OR REPLACE VIEW v3_5_statistics_vms_disks_resources_usage_samples
 AS
SELECT
    history_id as history_id,
    history_datetime as history_datetime,
...
CREATE OR REPLACE VIEW v3_5_statistics_vms_disks_resources_usage_hourly
 AS
SELECT
    history_id as history_id,
    history_datetime as history_datetime,
...
CREATE OR REPLACE VIEW v3_5_statistics_vms_disks_resources_usage_daily
 AS
SELECT
    history_id as history_id,
    history_datetime as history_datetime,
...
CREATE OR REPLACE VIEW v3_5_configuration_history_vms_devices
 AS
SELECT
    history_id as history_id,
    vm_id,
...
CREATE OR REPLACE VIEW v3_5_latest_configuration_vms_devices
 AS
SELECT
    history_id as history_id,
    vm_id,
...
CREATE OR REPLACE VIEW v3_5_tags_details_history
 AS
SELECT  history_id as history_id,
        tag_id as tag_id,
...
CREATE OR REPLACE VIEW v3_5_latest_tags_details
 AS
SELECT  history_id as history_id,
        tag_id as tag_id,
        tag_name as tag_name,
