...
CREATE OR REPLACE VIEW v4_3_enum_translator
 AS
SELECT
...
CREATE OR REPLACE VIEW v4_3_configuration_history_datacenters
 AS
SELECT
...
CREATE OR REPLACE VIEW v4_3_latest_configuration_datacenters
 AS
SELECT
      history_id as history_id,
      datacenter_id as datacenter_id,
...
CREATE OR REPLACE VIEW v4_3_map_history_datacenters_storage_domains
 AS
SELECT
    history_id as history_id,
...
CREATE OR REPLACE VIEW v4_3_latest_map_datacenters_storage_domains
 AS
SELECT
    history_id as history_id,
    storage_domain_id as storage_domain_id,
...
CREATE OR REPLACE VIEW v4_3_configuration_history_storage_domains
 AS
SELECT
      history_id as history_id,
      storage_domain_id as storage_domain_id,
...
CREATE OR REPLACE VIEW v4_3_latest_configuration_storage_domains
 AS
SELECT
      history_id as history_id,
      storage_domain_id as storage_domain_id,
...
CREATE OR REPLACE VIEW v4_3_statistics_storage_domains_resources_usage_samples
 AS
SELECT
      history_id as history_id,
...
CREATE OR REPLACE VIEW v4_3_statistics_storage_domains_resources_usage_hourly
 AS
SELECT
      history_id as history_id,
      history_datetime as history_datetime,
...
CREATE OR REPLACE VIEW v4_3_statistics_storage_domains_resources_usage_daily
 AS
SELECT
      history_id as history_id,
      history_datetime as history_datetime,
...
CREATE OR REPLACE VIEW v4_3_configuration_history_clusters
 AS
SELECT
      history_id as history_id,
...
CREATE OR REPLACE VIEW v4_3_latest_configuration_clusters
 AS
SELECT
      history_id as history_id,
      cluster_id as cluster_id,
...
CREATE OR REPLACE VIEW v4_3_configuration_history_hosts
 AS
SELECT
      history_id as history_id,
      host_id as host_id,
...
CREATE OR REPLACE VIEW v4_3_latest_configuration_hosts
 AS
SELECT
      history_id as history_id,
      host_id as host_id,
...
CREATE OR REPLACE VIEW v4_3_statistics_hosts_resources_usage_samples
 AS
SELECT
      history_id as history_id,
      history_datetime as history_datetime,
...
CREATE OR REPLACE VIEW v4_3_statistics_hosts_resources_usage_hourly
 AS
SELECT
      history_id as history_id,
      history_datetime as history_datetime,
...
CREATE OR REPLACE VIEW v4_3_statistics_hosts_resources_usage_daily
 AS
SELECT
      history_id as history_id,
      history_datetime as history_datetime,
...
CREATE OR REPLACE VIEW v4_3_configuration_history_hosts_interfaces
 AS
SELECT
      history_id as history_id,
...
CREATE OR REPLACE VIEW v4_3_latest_configuration_hosts_interfaces
 AS
SELECT
      history_id as history_id,
      host_interface_id as host_interface_id,
...
CREATE OR REPLACE VIEW v4_3_statistics_hosts_interfaces_resources_usage_samples
 AS
SELECT
      history_id as history_id,
      history_datetime as history_datetime,
...
CREATE OR REPLACE VIEW v4_3_statistics_hosts_interfaces_resources_usage_hourly
 AS
SELECT
      history_id as history_id,
      history_datetime as history_datetime,
...
CREATE OR REPLACE VIEW v4_3_statistics_hosts_interfaces_resources_usage_daily
 AS
...
CREATE OR REPLACE VIEW v4_3_fully_joined_statistics_hosts_resources_usage_samples
 AS
SELECT
...
FROM v4_3_configuration_history_hosts AS conf
    LEFT OUTER JOIN v4_3_statistics_hosts_resources_usage_samples AS stats
        ON (conf.history_id = stats.host_configuration_version)
    LEFT OUTER JOIN v4_3_configuration_history_hosts_interfaces nic_conf
        ON (conf.history_id = nic_conf.host_configuration_version)
    LEFT OUTER JOIN v4_3_statistics_hosts_interfaces_resources_usage_samples nic_stats
...
CREATE OR REPLACE VIEW v4_3_fully_joined_statistics_hosts_resources_usage_hourly
 AS
SELECT
    conf.host_id as host_id,
    conf.host_unique_id as host_unique_id,
    ...
    nic_stats.transmitted_total_byte as transmitted_total_byte
FROM v4_3_configuration_history_hosts AS conf
    LEFT OUTER JOIN v4_3_statistics_hosts_resources_usage_hourly AS stats
        ON (conf.history_id = stats.host_configuration_version)
    LEFT OUTER JOIN v4_3_configuration_history_hosts_interfaces nic_conf
        ON (conf.history_id = nic_conf.host_configuration_version)
    LEFT OUTER JOIN v4_3_statistics_hosts_interfaces_resources_usage_hourly nic_stats
        ON (nic_conf.history_id = nic_stats.host_interface_configuration_version AND
            stats.history_datetime = nic_stats.history_datetime);


CREATE OR REPLACE VIEW v4_3_fully_joined_statistics_hosts_resources_usage_daily
 AS
SELECT
    conf.host_id as host_id,
    conf.host_unique_id as host_unique_id,
    ...
    nic_stats.transmitted_total_byte as transmitted_total_byte
FROM v4_3_configuration_history_hosts AS conf
    LEFT OUTER JOIN v4_3_statistics_hosts_resources_usage_daily AS stats
        ON (conf.history_id = stats.host_configuration_version)
    LEFT OUTER JOIN v4_3_configuration_history_hosts_interfaces nic_conf
        ON (conf.history_id = nic_conf.host_configuration_version)
    LEFT OUTER JOIN v4_3_statistics_hosts_interfaces_resources_usage_daily nic_stats
        ON (nic_conf.history_id = nic_stats.host_interface_configuration_version AND
            stats.history_datetime = nic_stats.history_datetime);


CREATE OR REPLACE VIEW v4_3_configuration_history_vms
 AS
SELECT
      history_id as history_id,
      vm_id as vm_id,
...
CREATE OR REPLACE VIEW v4_3_latest_configuration_vms
 AS
SELECT
      history_id as history_id,
      vm_id as vm_id,
...
CREATE OR REPLACE VIEW v4_3_statistics_vms_resources_usage_samples
 AS
SELECT
...
CREATE OR REPLACE VIEW v4_3_statistics_vms_resources_usage_hourly
 AS
SELECT
    a.history_id as history_id,
    a.history_datetime as history_datetime,
...
CREATE OR REPLACE VIEW v4_3_statistics_vms_resources_usage_daily
 AS
SELECT
    a.history_id as history_id,
    a.history_datetime as history_datetime,
...
CREATE OR REPLACE VIEW v4_3_statistics_vms_users_usage_hourly
 AS
SELECT history_id,
       history_datetime,
       user_id,
...
CREATE OR REPLACE VIEW v4_3_statistics_vms_users_usage_daily
 AS
SELECT history_id,
       history_datetime,
       user_id,
...
CREATE OR REPLACE VIEW v4_3_configuration_history_vms_interfaces
 AS
SELECT
      history_id as history_id,
...
CREATE OR REPLACE VIEW v4_3_latest_configuration_vms_interfaces
 AS
SELECT
      history_id as history_id,
      vm_interface_id as vm_interface_id,
...
CREATE OR REPLACE VIEW v4_3_statistics_vms_interfaces_resources_usage_samples
 AS
...
CREATE OR REPLACE VIEW v4_3_statistics_vms_interfaces_resources_usage_hourly
 AS
...
CREATE OR REPLACE VIEW v4_3_statistics_vms_interfaces_resources_usage_daily
 AS
...
CREATE OR REPLACE VIEW v4_3_configuration_history_vms_disks
 AS
SELECT
    history_id as history_id,
...
CREATE OR REPLACE VIEW v4_3_latest_configuration_vms_disks
 AS
SELECT
    history_id as history_id,
    vm_disk_id as vm_disk_id,
...
CREATE OR REPLACE VIEW v4_3_statistics_vms_disks_resources_usage_samples
 AS
SELECT
    history_id as history_id,
    history_datetime as history_datetime,
...
CREATE OR REPLACE VIEW v4_3_statistics_vms_disks_resources_usage_hourly
 AS
SELECT
    history_id as history_id,
    history_datetime as history_datetime,
...
CREATE OR REPLACE VIEW v4_3_statistics_vms_disks_resources_usage_daily
 AS
SELECT
    history_id as history_id,
    history_datetime as history_datetime,
...
CREATE OR REPLACE VIEW v4_3_configuration_history_vms_devices
 AS
SELECT
    history_id as history_id,
    vm_id,
...
CREATE OR REPLACE VIEW v4_3_latest_configuration_vms_devices
 AS
SELECT
    history_id as history_id,
    vm_id,
...
CREATE OR REPLACE VIEW v4_3_fully_joined_statistics_vms_resources_usage_samples
 AS
 SELECT
    conf.vm_id as vm_id,
...
FROM v4_3_configuration_history_vms AS conf
    LEFT OUTER JOIN v4_3_statistics_vms_resources_usage_samples AS stats
        ON (conf.history_id = stats.vm_configuration_version)
    LEFT OUTER JOIN  v4_3_configuration_history_vms_devices device_conf
        ON (conf.history_id = device_conf.vm_configuration_version)
    LEFT OUTER JOIN v4_3_configuration_history_vms_disks disk_conf
        ON (device_conf.device_configuration_version = disk_conf.history_id)
    LEFT OUTER JOIN v4_3_configuration_history_vms_interfaces AS nic_conf
        ON (device_conf.device_configuration_version = nic_conf.history_id  AND
            conf.history_id = nic_conf.vm_configuration_version)
    LEFT OUTER JOIN v4_3_statistics_vms_interfaces_resources_usage_samples AS nic_stats
        ON (nic_conf.history_id = nic_stats.vm_interface_configuration_version AND
            stats.history_datetime = nic_stats.history_datetime)
    LEFT OUTER JOIN v4_3_statistics_vms_disks_resources_usage_samples disk_stats
        ON (disk_conf.history_id = disk_stats.vm_disk_configuration_version AND
            stats.history_datetime = disk_stats.history_datetime);

CREATE OR REPLACE VIEW v4_3_fully_joined_statistics_vms_resources_usage_hourly
 AS
 SELECT
    conf.vm_id as vm_id,
    conf.vm_name as vm_name,
...
FROM v4_3_configuration_history_vms AS conf
    LEFT OUTER JOIN v4_3_statistics_vms_resources_usage_hourly AS stats
        ON (conf.history_id = stats.vm_configuration_version)
    LEFT OUTER JOIN  v4_3_configuration_history_vms_devices device_conf
        ON (conf.history_id = device_conf.vm_configuration_version)
    LEFT OUTER JOIN v4_3_configuration_history_vms_disks disk_conf
    ...
    LEFT OUTER JOIN v4_3_configuration_history_vms_interfaces AS nic_conf
        ON (device_conf.device_configuration_version = nic_conf.history_id  AND
            conf.history_id = nic_conf.vm_configuration_version)
    LEFT OUTER JOIN v4_3_statistics_vms_interfaces_resources_usage_hourly AS nic_stats
        ON (nic_conf.history_id = nic_stats.vm_interface_configuration_version AND
            stats.history_datetime = nic_stats.history_datetime)
    LEFT OUTER JOIN v4_3_statistics_vms_disks_resources_usage_hourly disk_stats
        ON (disk_conf.history_id = disk_stats.vm_disk_configuration_version AND
            stats.history_datetime = disk_stats.history_datetime);


CREATE OR REPLACE VIEW v4_3_fully_joined_statistics_vms_resources_usage_daily
 AS
 SELECT
    conf.vm_id as vm_id,
    conf.vm_name as vm_name,
    ...
    disk_stats.max_flush_latency_seconds as max_flush_latency_seconds
FROM v4_3_configuration_history_vms AS conf
    LEFT OUTER JOIN v4_3_statistics_vms_resources_usage_daily AS stats
        ON (conf.history_id = stats.vm_configuration_version)
    LEFT OUTER JOIN  v4_3_configuration_history_vms_devices device_conf
        ON (conf.history_id = device_conf.vm_configuration_version)
    LEFT OUTER JOIN v4_3_configuration_history_vms_disks disk_conf
    ...
    LEFT OUTER JOIN v4_3_configuration_history_vms_interfaces AS nic_conf
        ON (device_conf.device_configuration_version = nic_conf.history_id  AND
            conf.history_id = nic_conf.vm_configuration_version)
    LEFT OUTER JOIN v4_3_statistics_vms_interfaces_resources_usage_daily AS nic_stats
        ON (nic_conf.history_id = nic_stats.vm_interface_configuration_version AND
            stats.history_datetime = nic_stats.history_datetime)
    LEFT OUTER JOIN v4_3_statistics_vms_disks_resources_usage_daily disk_stats
        ON (disk_conf.history_id = disk_stats.vm_disk_configuration_version AND
            stats.history_datetime = disk_stats.history_datetime);

CREATE OR REPLACE VIEW v4_3_users_details_history
 AS
SELECT
      user_id,
      first_name,
...
CREATE OR REPLACE VIEW v4_3_latest_users_details
 AS
SELECT
      user_id,
      first_name,
...
CREATE OR REPLACE VIEW v4_3_tags_relations_history
 AS
...
CREATE OR REPLACE VIEW v4_3_latest_tags_relations
 AS
SELECT    history_id as history_id,
        entity_id as entity_id,
        entity_type as entity_type,
...
CREATE OR REPLACE VIEW v4_3_tags_details_history
 AS
SELECT  history_id as history_id,
        tag_id as tag_id,
...
CREATE OR REPLACE VIEW v4_3_latest_tags_details
 AS
SELECT  history_id as history_id,
        tag_id as tag_id,
        tag_name as tag_name,
