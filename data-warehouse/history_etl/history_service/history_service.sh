...
CP=$ETL_HOME:$ETL_HOME/historyETLProcedure-3.1.0.jar:$ETL_HOME/lib/advancedPersistentLookupLib-1.0.jar:$ETL_HOME/lib/talendRoutines-5.1.0.r84309.jar:$ETL_HOME/lib/xml-apis-1.0.b2.jar:$ETL_HOME/lib/trove.jar:$ETL_HOME/lib/jboss-serialization.jar:$JAVA_DIR/dom4j.jar:$JAVA_DIR/commons-collections.jar:$JAVA_DIR/log4j.jar:$JAVA_DIR/postgresql-jdbc.jar
