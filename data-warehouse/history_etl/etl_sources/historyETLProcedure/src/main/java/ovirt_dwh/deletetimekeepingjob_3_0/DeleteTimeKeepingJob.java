...
//
// ============================================================================
package ovirt_dwh.deletetimekeepingjob_3_0;
	...
	public void tRunJob_2Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				ovirt_dwh.historydelete_3_0.HistoryDelete childJob_tRunJob_2 = new ovirt_dwh.historydelete_3_0.HistoryDelete();
		...
		try {
			...
			java.io.InputStream inContext = DeleteTimeKeepingJob.class
					.getClassLoader().getResourceAsStream(
							"ovirt_dwh/deletetimekeepingjob_3_0/contexts/"
