...
//
// ============================================================================
package ovirt_dwh.aggregationtodaily_3_0;
				...
				while (rs_tJDBCInput_1.next()) {
					...
					if (colQtyInRs_tJDBCInput_1 < 2) {
						...
						if (timestamp_tJDBCInput_1 != null) {
							row1.history_datetime = new java.util.Date(
				...
				while (rs_tJDBCInput_2.next()) {
					...
					if (colQtyInRs_tJDBCInput_2 < 2) {
						...
						if (timestamp_tJDBCInput_2 != null) {
							row2.history_datetime = new java.util.Date(
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				while (rs_tJDBCInput_3.next()) {
					...
					if (colQtyInRs_tJDBCInput_3 < 2) {
						...
						java.sql.Timestamp timestamp_tJDBCInput_3 = rs_tJDBCInput_3
								.getTimestamp(2);
						if (timestamp_tJDBCInput_3 != null) {
							row3.history_datetime = new java.util.Date(
									timestamp_tJDBCInput_3.getTime());
						} else {
							row3.history_datetime = null;
						}
				...
				while (rs_tJDBCInput_4.next()) {
					...
					if (colQtyInRs_tJDBCInput_4 < 2) {
						...
						if (timestamp_tJDBCInput_4 != null) {
							row4.history_datetime = new java.util.Date(
					...
					if (colQtyInRs_tJDBCInput_4 < 10) {
						...
						java.sql.Timestamp timestamp_tJDBCInput_4 = rs_tJDBCInput_4
								.getTimestamp(10);
						if (timestamp_tJDBCInput_4 != null) {
							row4.vm_last_up_time = new java.util.Date(
									timestamp_tJDBCInput_4.getTime());
						} else {
							row4.vm_last_up_time = null;
						}
					...
					if (colQtyInRs_tJDBCInput_4 < 11) {
						...
						java.sql.Timestamp timestamp_tJDBCInput_4 = rs_tJDBCInput_4
								.getTimestamp(11);
						if (timestamp_tJDBCInput_4 != null) {
							row4.vm_last_boot_time = new java.util.Date(
									timestamp_tJDBCInput_4.getTime());
						} else {
							row4.vm_last_boot_time = null;
						}
				...
				while (rs_tJDBCInput_5.next()) {
					...
					if (colQtyInRs_tJDBCInput_5 < 2) {
						...
						if (timestamp_tJDBCInput_5 != null) {
							row5.history_datetime = new java.util.Date(
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				while (rs_tJDBCInput_11.next()) {
					...
					if (colQtyInRs_tJDBCInput_11 < 2) {
						...
						java.sql.Timestamp timestamp_tJDBCInput_11 = rs_tJDBCInput_11
								.getTimestamp(2);
						if (timestamp_tJDBCInput_11 != null) {
							row16.history_datetime = new java.util.Date(
									timestamp_tJDBCInput_11.getTime());
						} else {
							row16.history_datetime = null;
						}
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				while (rs_tJDBCInput_13.next()) {
					...
					if (colQtyInRs_tJDBCInput_13 < 1) {
						...
						java.sql.Timestamp timestamp_tJDBCInput_13 = rs_tJDBCInput_13
								.getTimestamp(1);
						if (timestamp_tJDBCInput_13 != null) {
							row19.history_datetime = new java.util.Date(
									timestamp_tJDBCInput_13.getTime());
						} else {
							row19.history_datetime = null;
						}
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				while (rs_tJDBCInput_6.next()) {
					...
					if (colQtyInRs_tJDBCInput_6 < 3) {
						...
						java.sql.Timestamp timestamp_tJDBCInput_6 = rs_tJDBCInput_6
								.getTimestamp(3);
						if (timestamp_tJDBCInput_6 != null) {
							row11.var_datetime = new java.util.Date(
									timestamp_tJDBCInput_6.getTime());
						} else {
							row11.var_datetime = null;
						}
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				while (rs_tJDBCInput_9.next()) {
					...
					if (colQtyInRs_tJDBCInput_9 < 1) {
						...
						java.sql.Timestamp timestamp_tJDBCInput_9 = rs_tJDBCInput_9
								.getTimestamp(1);
						if (timestamp_tJDBCInput_9 != null) {
							row12.history_datetime = new java.util.Date(
									timestamp_tJDBCInput_9.getTime());
						} else {
							row12.history_datetime = null;
						}
		...
		try {
			...
			java.io.InputStream inContext = AggregationToDaily.class
					.getClassLoader().getResourceAsStream(
							"ovirt_dwh/aggregationtodaily_3_0/contexts/"
...
/************************************************************************************************
 * 579207 characters generated by Talend Open Studio on the October 16, 2011
 * 11:10:00 AM IST
 ************************************************************************************************/
