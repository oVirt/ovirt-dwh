...
//
// ============================================================================
package ovirt_dwh.minimalversioncheck_3_0;
...
public class MinimalVersionCheck implements TalendJob {
	...
	public class ContextProperties extends java.util.Properties {
		...
		public void synchronizeContext() {
			...
			if (ovirtHistoryMinimalETL != null) {

				this.setProperty("ovirtHistoryMinimalETL",
						ovirtHistoryMinimalETL.toString());
		...
		public String ovirtHistoryMinimalETL;

		public String getOvirtHistoryMinimalETL() {
			return this.ovirtHistoryMinimalETL;
		}
	...
	public void tJDBCInput_1Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
					...
					if (tmp_key_tContextLoad_1 != null) {
						try {
							if (key_tContextLoad_1 != null
									&& "ovirtHistoryMinimalETL"
											.equals(key_tContextLoad_1)) {
								context.ovirtHistoryMinimalETL = value_tContextLoad_1;
							}
				...
				if (context.ovirtMinimalETL.substring(0, 3).equals(
	...
	public void tJDBCInput_2Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String dbquery_tJDBCInput_2 = "select distinct 'ovirtHistoryMinimalETL', var_value  from history_configuration  where var_name = 'MinimalETLVersion'";
					...
					if (tmp_key_tContextLoad_2 != null) {
						try {
							if (key_tContextLoad_2 != null
								...
								context.ovirtHistoryMinimalETL = value_tContextLoad_2;
							}
				...
				if (!context.ovirtHistoryMinimalETL.substring(0, 3).equals(
						context.etlVersion.substring(0, 3))
						|| Integer.parseInt(context.ovirtHistoryMinimalETL
								.substring(4)) > Integer
								.parseInt(context.etlVersion.substring(4))) {
				...
				talendLogs_LOGS
						.addMessage(
								...
								TalendDate.getDate("YYYY-MM-DD hh:mm:ss")
										+ "|You have upgraded the ovirt-dwh package and now require an upgrade of the oVirt history database. Please run ovirt-dwh-setup. Service will now exit.",
								4);
				talendLogs_LOGSProcess(globalMap);
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				talendLogs_LOGS
						.addMessage(
								...
								5,
								TalendDate.getDate("YYYY-MM-DD hh:mm:ss")
										+ "|You have upgraded your oVirt Engine and now require an upgrade of the ovirt-dwh package. Please upgrade using yum and run ovirt-dwh-setup. Service will now exit.",
								4);
				talendLogs_LOGSProcess(globalMap);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = MinimalVersionCheck.class
					.getClassLoader().getResourceAsStream(
							"ovirt_dwh/minimalversioncheck_3_0/contexts/"
			...
			if (isDefaultContext && inContext == null) {
				...
				context.ovirtHistoryMinimalETL = (String) context
						.getProperty("ovirtHistoryMinimalETL");
		...
		if (parentContextMap != null && !parentContextMap.isEmpty()) {
			if (parentContextMap.containsKey("ovirtHistoryMinimalETL")) {
				context.ovirtHistoryMinimalETL = (String) parentContextMap
						.get("ovirtHistoryMinimalETL");
			}
...
/************************************************************************************************
 * 74839 characters generated by Talend Open Studio for Data Integration on the
 * March 12, 2012 3:16:16 PM IST
 ************************************************************************************************/
