...
//
// ============================================================================
package ovirt_dwh.hourlytimekeepingjob_3_0;
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				ovirt_dwh.aggregationtohourly_3_0.AggregationToHourly childJob_tRunJob_1 = new ovirt_dwh.aggregationtohourly_3_0.AggregationToHourly();
		...
		try {
			...
			java.io.InputStream inContext = HourlyTimeKeepingJob.class
					.getClassLoader().getResourceAsStream(
							"ovirt_dwh/hourlytimekeepingjob_3_0/contexts/"
...
/************************************************************************************************
 * 68630 characters generated by Talend Open Studio for Data Integration on the
