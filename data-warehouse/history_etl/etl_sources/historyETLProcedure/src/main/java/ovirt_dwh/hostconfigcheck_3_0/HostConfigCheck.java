...
//
// ============================================================================
package ovirt_dwh.hostconfigcheck_3_0;
...
public class HostConfigCheck implements TalendJob {
		...
		public void synchronizeContext() {
			...
			if (lastFullHostCheck != null) {
				...
				if (parts_lastFullHostCheck.length > 1) {
					...
					this.setProperty("lastFullHostCheck",
	...
	public void tJDBCInput_4Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String dbquery_tJDBCInput_4 = "SELECT var_name, var_datetime  FROM  dwh_history_timekeeping  where var_name = 'lastFullHostCheck'";
				...
				while (rs_tJDBCInput_4.next()) {
					...
					if (colQtyInRs_tJDBCInput_4 < 2) {
						...
						java.sql.Timestamp timestamp_tJDBCInput_4 = rs_tJDBCInput_4
								.getTimestamp(2);
						if (timestamp_tJDBCInput_4 != null) {
							row3.value = new java.util.Date(
									timestamp_tJDBCInput_4.getTime());
						} else {
							row3.value = null;
						}
	...
	public void tJDBCInput_2Process(
		...
		try {
				...
				while (rs_tJDBCInput_2.next()) {
					...
					if (colQtyInRs_tJDBCInput_2 < 2) {
						...
						if (tmpContent_tJDBCInput_2 != null) {
							row2.host_join_id = tmpContent_tJDBCInput_2;
						} else {
							row2.host_join_id = null;
						}
					...
					if (colQtyInRs_tJDBCInput_2 < 3) {
						...
						tmpContent_tJDBCInput_2 = rs_tJDBCInput_2.getString(3);
						if (tmpContent_tJDBCInput_2 != null) {
							row2.host_unique_id = tmpContent_tJDBCInput_2;
						} else {
							row2.host_unique_id = null;
						}
					...
					if (colQtyInRs_tJDBCInput_2 < 4) {
						...
						tmpContent_tJDBCInput_2 = rs_tJDBCInput_2.getString(4);
						if (tmpContent_tJDBCInput_2 != null) {
							row2.host_name = tmpContent_tJDBCInput_2;
						} else {
							row2.host_name = null;
						}
					...
					if (colQtyInRs_tJDBCInput_2 < 6) {
						...
						tmpContent_tJDBCInput_2 = rs_tJDBCInput_2.getString(6);
						if (tmpContent_tJDBCInput_2 != null) {
							row2.cluster_join_id = tmpContent_tJDBCInput_2;
						} else {
							row2.cluster_join_id = null;
						}
					...
					if (colQtyInRs_tJDBCInput_2 < 8) {
						...
						tmpContent_tJDBCInput_2 = rs_tJDBCInput_2.getString(8);
						if (tmpContent_tJDBCInput_2 != null) {
							row2.fqn_or_ip = tmpContent_tJDBCInput_2;
						} else {
							row2.fqn_or_ip = null;
						}
					...
					if (colQtyInRs_tJDBCInput_2 < 11) {
						...
						tmpContent_tJDBCInput_2 = rs_tJDBCInput_2.getString(11);
						if (tmpContent_tJDBCInput_2 != null) {
							row2.cpu_model = tmpContent_tJDBCInput_2;
						} else {
							row2.cpu_model = null;
						}
					...
					if (colQtyInRs_tJDBCInput_2 < 12) {
						...
						if (rs_tJDBCInput_2.getObject(12) != null) {
							row2.number_of_cores = rs_tJDBCInput_2.getShort(12);
						} else {
							row2.number_of_cores = null;
						}
					...
					if (colQtyInRs_tJDBCInput_2 < 19) {
						...
						if (timestamp_tJDBCInput_2 != null) {
							row2.create_date = new java.util.Date(
					...
					if (colQtyInRs_tJDBCInput_2 < 20) {
						...
						java.sql.Timestamp timestamp_tJDBCInput_2 = rs_tJDBCInput_2
								.getTimestamp(20);
						if (timestamp_tJDBCInput_2 != null) {
							row2.update_date = new java.util.Date(
									timestamp_tJDBCInput_2.getTime());
						} else {
							row2.update_date = null;
						}
					...
					{ // start of Var scope
						...
						if (rejectedInnerJoin_tMap_1) {
							...
							host_changes_tmp.fqn_or_ip = StringHandling
									.TRIM(row2.fqn_or_ip);
					...
					if (host_changes != null) {
						...
						if (host_changes.host_id == null) {
							pstmt_tJDBCOutput_1
									.setNull(1, java.sql.Types.OTHER);
						} else {
						...
						if (host_changes.cluster_id == null) {
							pstmt_tJDBCOutput_1
									.setNull(4, java.sql.Types.OTHER);
						} else {
							pstmt_tJDBCOutput_1.setObject(4,
									host_changes.cluster_id);
						}

						pstmt_tJDBCOutput_1.setShort(5, host_changes.host_type);

						if (host_changes.fqn_or_ip == null) {
							pstmt_tJDBCOutput_1.setNull(6,
									java.sql.Types.VARCHAR);
						} else {
							pstmt_tJDBCOutput_1.setString(6,
									host_changes.fqn_or_ip);
						}
			...
			globalMap.put("tHash_Lookup_row21", null);
	...
	public void tJDBCInput_5Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String dbquery_tJDBCInput_5 = "SELECT *  FROM  dwh_history_timekeeping  where var_name = 'lastFullHostCheck'";
				...
				while (rs_tJDBCInput_5.next()) {
					...
					if (colQtyInRs_tJDBCInput_5 < 1) {
						...
						if (tmpContent_tJDBCInput_5 != null) {
							row34.var_name = tmpContent_tJDBCInput_5;
						} else {
							row34.var_name = null;
						}
					...
					if (colQtyInRs_tJDBCInput_5 < 2) {
						...
						if (tmpContent_tJDBCInput_5 != null) {
							row34.var_value = tmpContent_tJDBCInput_5;
						} else {
							row34.var_value = null;
						}
					...
					if (colQtyInRs_tJDBCInput_5 < 3) {
						...
						java.sql.Timestamp timestamp_tJDBCInput_5 = rs_tJDBCInput_5
								.getTimestamp(3);
						if (timestamp_tJDBCInput_5 != null) {
							row34.var_datetime = new java.util.Date(
									timestamp_tJDBCInput_5.getTime());
						} else {
							row34.var_datetime = null;
						}
					...
					if (update_lastSync != null) {
						...
						if (update_lastSync.var_datetime != null) {
							pstmt_tJDBCOutput_2.setTimestamp(2,
	...
	public void tJDBCInput_1Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				start_Hash.put("tAdvancedHash_row21", System
						.currentTimeMillis());
				...
				while (rs_tJDBCInput_1.next()) {
					...
					if (colQtyInRs_tJDBCInput_1 < 1) {
						...
						if (tmpContent_tJDBCInput_1 != null) {
							row21.host_join_id = tmpContent_tJDBCInput_1;
						} else {
							row21.host_join_id = null;
						}
					...
					if (colQtyInRs_tJDBCInput_1 < 2) {
						...
						if (rs_tJDBCInput_1.getObject(2) != null) {
							row21.memory_size_mb = rs_tJDBCInput_1.getInt(2);
						} else {
							row21.memory_size_mb = null;
						}
					...
					if (colQtyInRs_tJDBCInput_1 < 4) {
						...
						tmpContent_tJDBCInput_1 = rs_tJDBCInput_1.getString(4);
						if (tmpContent_tJDBCInput_1 != null) {
							row21.cpu_model = tmpContent_tJDBCInput_1;
						} else {
							row21.cpu_model = null;
						}
					...
					if (colQtyInRs_tJDBCInput_1 < 5) {
						...
						if (rs_tJDBCInput_1.getObject(5) != null) {
							row21.number_of_cores = rs_tJDBCInput_1.getShort(5);
						} else {
							row21.number_of_cores = null;
						}
				...
				while (rs_tJDBCInput_3.next()) {
					...
					if (colQtyInRs_tJDBCInput_3 < 2) {
						...
						if (tmpContent_tJDBCInput_3 != null) {
							row1.cluster_join_id = tmpContent_tJDBCInput_3;
						} else {
							row1.cluster_join_id = null;
						}
		...
		try {
			...
			java.io.InputStream inContext = HostConfigCheck.class
					.getClassLoader().getResourceAsStream(
							"ovirt_dwh/hostconfigcheck_3_0/contexts/"
...
/************************************************************************************************
 * 173879 characters generated by Talend Open Studio on the October 16, 2011
 * 11:10:06 AM IST
 ************************************************************************************************/
