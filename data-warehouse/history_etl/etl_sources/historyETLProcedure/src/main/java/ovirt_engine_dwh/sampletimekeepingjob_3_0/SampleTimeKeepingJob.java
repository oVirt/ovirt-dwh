...
//
// ============================================================================
package ovirt_engine_dwh.sampletimekeepingjob_3_0;
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				parentContextMap_tRunJob_1.put("ovirtEnginePortalPort",
						context.ovirtEnginePortalPort);
				parentContextMap_tRunJob_1.put("ovirtEngineHistoryDbDriverClass",
						context.ovirtEngineHistoryDbDriverClass);
				parentContextMap_tRunJob_1.put("ovirtEngineHistoryDbJdbcConnection",
				...
				ovirt_engine_dwh.samplerunjobs_3_0.SampleRunJobs childJob_tRunJob_1 = new ovirt_engine_dwh.samplerunjobs_3_0.SampleRunJobs();
		...
		try {
			...
			java.io.InputStream inContext = SampleTimeKeepingJob.class
					.getClassLoader().getResourceAsStream(
							"ovirt_engine_dwh/sampletimekeepingjob_3_0/contexts/"
