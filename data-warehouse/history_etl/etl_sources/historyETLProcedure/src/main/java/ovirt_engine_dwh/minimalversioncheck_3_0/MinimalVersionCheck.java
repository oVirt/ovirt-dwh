...
//
// ============================================================================
package ovirt_engine_dwh.minimalversioncheck_3_0;
	...
	public void tJDBCInput_2Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				if (!context.ovirtEngineHistoryMinimalETL.substring(0, 3).equals(
						context.etlVersion.substring(0, 3))
						|| Integer.parseInt(context.ovirtEngineHistoryMinimalETL
								.substring(4)) > Integer
								.parseInt(context.etlVersion.substring(4))) {
				...
				talendLogs_LOGS
						.addMessage(
								...
								TalendDate.getDate("YYYY-MM-DD hh:mm:ss")
										+ "|You have upgraded the ovirt-engine-dwh package and now require an upgrade of the oVirt Engine History database. Please run ovirt-engine-dwh-setup. Service will now exit.",
								4);
				talendLogs_LOGSProcess(globalMap);
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				talendLogs_LOGS
						.addMessage(
								...
								5,
								TalendDate.getDate("YYYY-MM-DD hh:mm:ss")
										+ "|You have upgraded your oVirt Engine and now require an upgrade of the ovirt-engine-dwh package. Please upgrade using yum and run ovirt-engine-dwh-setup. Service will now exit.",
								4);
				talendLogs_LOGSProcess(globalMap);
		...
		try {
			...
			java.io.InputStream inContext = MinimalVersionCheck.class
					.getClassLoader().getResourceAsStream(
							"ovirt_engine_dwh/minimalversioncheck_3_0/contexts/"
