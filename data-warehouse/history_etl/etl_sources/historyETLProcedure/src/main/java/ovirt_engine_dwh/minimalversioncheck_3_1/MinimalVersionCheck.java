...
//
// ============================================================================
package ovirt_engine_dwh.minimalversioncheck_3_1;
	...
	public void tJDBCInput_2Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				if (!context.ovirtEngineHistoryMinimalETL.substring(0, 3)
						.equals(context.etlVersion.substring(0, 3))
						|| Integer
		...
		try {
			...
			java.io.InputStream inContext = MinimalVersionCheck.class
					.getClassLoader().getResourceAsStream(
							"ovirt_engine_dwh/minimalversioncheck_3_1/contexts/"
...
/************************************************************************************************
 * 75872 characters generated by Talend Open Studio for Data Integration on the
