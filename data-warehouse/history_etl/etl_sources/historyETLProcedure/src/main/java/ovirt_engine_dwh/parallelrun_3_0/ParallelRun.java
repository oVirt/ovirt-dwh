...
//
// ============================================================================
package ovirt_engine_dwh.parallelrun_3_0;
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				while (counter_tInfiniteLoop_6 > -1) {
					...
					ovirt_engine_dwh.deletetimekeepingjob_3_0.DeleteTimeKeepingJob childJob_tRunJob_6 = new ovirt_engine_dwh.deletetimekeepingjob_3_0.DeleteTimeKeepingJob();
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				while (counter_tInfiniteLoop_3 > -1) {
					...
					parentContextMap_tRunJob_3.put("ovirtEnginePortalPort",
							context.ovirtEnginePortalPort);
					parentContextMap_tRunJob_3.put("ovirtEngineHistoryDbDriverClass",
							context.ovirtEngineHistoryDbDriverClass);
					parentContextMap_tRunJob_3.put(
							"ovirtEngineHistoryDbJdbcConnection",
							context.ovirtEngineHistoryDbJdbcConnection);
					parentContextMap_tRunJob_3.put("ovirtEngineHistoryDbPassword",
							context.ovirtEngineHistoryDbPassword);
					...
					ovirt_engine_dwh.dailytimekeepingjob_3_0.DailyTimeKeepingJob childJob_tRunJob_3 = new ovirt_engine_dwh.dailytimekeepingjob_3_0.DailyTimeKeepingJob();
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				while (counter_tInfiniteLoop_1 > -1) {
					...
					ovirt_engine_dwh.sampletimekeepingjob_3_0.SampleTimeKeepingJob childJob_tRunJob_1 = new ovirt_engine_dwh.sampletimekeepingjob_3_0.SampleTimeKeepingJob();
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				while (counter_tInfiniteLoop_2 > -1) {
					...
					parentContextMap_tRunJob_2.put("ovirtEnginePortalPort",
							context.ovirtEnginePortalPort);
					parentContextMap_tRunJob_2.put("ovirtEngineHistoryDbDriverClass",
							context.ovirtEngineHistoryDbDriverClass);
					parentContextMap_tRunJob_2.put(
							"ovirtEngineHistoryDbJdbcConnection",
							context.ovirtEngineHistoryDbJdbcConnection);
					...
					ovirt_engine_dwh.hourlytimekeepingjob_3_0.HourlyTimeKeepingJob childJob_tRunJob_2 = new ovirt_engine_dwh.hourlytimekeepingjob_3_0.HourlyTimeKeepingJob();
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = ParallelRun.class.getClassLoader()
					.getResourceAsStream(
							"ovirt_engine_dwh/parallelrun_3_0/contexts/" + contextStr
									+ ".properties");
...
/************************************************************************************************
 * 118247 characters generated by Talend Open Studio for Data Integration on the
 * March 12, 2012 3:16:15 PM IST
 ************************************************************************************************/
