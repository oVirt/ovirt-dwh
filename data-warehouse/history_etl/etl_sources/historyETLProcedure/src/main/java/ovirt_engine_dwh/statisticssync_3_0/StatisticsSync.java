...
//
// ============================================================================
package ovirt_engine_dwh.statisticssync_3_0;
	...
	public class ContextProperties extends java.util.Properties {
		...
		public void synchronizeContext() {
			...
			if (ovirtEngineHistoryDbUser != null) {
				...
				this.setProperty("ovirtEngineHistoryDbUser", ovirtEngineHistoryDbUser
						.toString());
				...
				while (rs_tJDBCInput_18.next()) {
					...
					if (colQtyInRs_tJDBCInput_18 < 2) {
						...
						if (rs_tJDBCInput_18.getObject(2) != null) {
							row1.image_id = rs_tJDBCInput_18.getObject(2);
						} else {
							row1.image_id = null;
						}
		...
		try {
			...
			java.io.InputStream inContext = StatisticsSync.class
					.getClassLoader().getResourceAsStream(
							"ovirt_engine_dwh/statisticssync_3_0/contexts/"
...
/************************************************************************************************
 * 445043 characters generated by Talend Open Studio for Data Integration on the
 * April 29, 2012 5:28:42 PM IDT
 ************************************************************************************************/
