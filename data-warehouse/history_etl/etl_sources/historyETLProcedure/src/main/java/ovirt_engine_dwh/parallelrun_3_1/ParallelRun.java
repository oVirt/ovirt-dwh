...
//
// ============================================================================
package ovirt_engine_dwh.parallelrun_3_1;
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				while (counter_tInfiniteLoop_1 > -1) {
					...
					ovirt_engine_dwh.sampletimekeepingjob_3_1.SampleTimeKeepingJob childJob_tRunJob_1 = new ovirt_engine_dwh.sampletimekeepingjob_3_1.SampleTimeKeepingJob();
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				while (counter_tInfiniteLoop_2 > -1) {
					...
					ovirt_engine_dwh.hourlytimekeepingjob_3_1.HourlyTimeKeepingJob childJob_tRunJob_2 = new ovirt_engine_dwh.hourlytimekeepingjob_3_1.HourlyTimeKeepingJob();
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = ParallelRun.class.getClassLoader()
					.getResourceAsStream(
							"ovirt_engine_dwh/parallelrun_3_1/contexts/"
