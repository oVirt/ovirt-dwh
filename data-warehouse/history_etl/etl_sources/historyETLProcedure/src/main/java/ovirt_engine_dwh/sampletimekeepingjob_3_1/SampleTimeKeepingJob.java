...
//
// ============================================================================
package ovirt_engine_dwh.sampletimekeepingjob_3_1;
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				ovirt_engine_dwh.samplerunjobs_3_1.SampleRunJobs childJob_tRunJob_1 = new ovirt_engine_dwh.samplerunjobs_3_1.SampleRunJobs();
		...
		try {
			...
			java.io.InputStream inContext = SampleTimeKeepingJob.class
					.getClassLoader().getResourceAsStream(
							"ovirt_engine_dwh/sampletimekeepingjob_3_1/contexts/"
...
/************************************************************************************************
 * 114788 characters generated by Talend Open Studio for Data Integration on the
 * October 18, 2012 6:06:17 PM IST
 ************************************************************************************************/
