...
//
// ============================================================================
package ovirt_engine_dwh.dailytimekeepingjob_3_1;
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				ovirt_engine_dwh.aggregationtodaily_3_1.AggregationToDaily childJob_tRunJob_1 = new ovirt_engine_dwh.aggregationtodaily_3_1.AggregationToDaily();
		...
		try {
			...
			java.io.InputStream inContext = DailyTimeKeepingJob.class
					.getClassLoader().getResourceAsStream(
							"ovirt_engine_dwh/dailytimekeepingjob_3_1/contexts/"
...
/************************************************************************************************
 * 72207 characters generated by Talend Open Studio for Data Integration on the
 * June 17, 2012 6:23:15 PM IDT
 ************************************************************************************************/
