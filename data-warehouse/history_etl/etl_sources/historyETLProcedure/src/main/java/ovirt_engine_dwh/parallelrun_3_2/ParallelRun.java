...
//
// ============================================================================
package ovirt_engine_dwh.parallelrun_3_2;
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				while (counter_tInfiniteLoop_1 > -1) {
					...
					ovirt_engine_dwh.sampletimekeepingjob_3_2.SampleTimeKeepingJob childJob_tRunJob_1 = new ovirt_engine_dwh.sampletimekeepingjob_3_2.SampleTimeKeepingJob();
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				while (counter_tInfiniteLoop_2 > -1) {
					...
					ovirt_engine_dwh.hourlytimekeepingjob_3_2.HourlyTimeKeepingJob childJob_tRunJob_2 = new ovirt_engine_dwh.hourlytimekeepingjob_3_2.HourlyTimeKeepingJob();
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				while (counter_tInfiniteLoop_3 > -1) {
					...
					ovirt_engine_dwh.dailytimekeepingjob_3_2.DailyTimeKeepingJob childJob_tRunJob_3 = new ovirt_engine_dwh.dailytimekeepingjob_3_2.DailyTimeKeepingJob();
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				while (counter_tInfiniteLoop_6 > -1) {
					...
					ovirt_engine_dwh.deletetimekeepingjob_3_2.DeleteTimeKeepingJob childJob_tRunJob_6 = new ovirt_engine_dwh.deletetimekeepingjob_3_2.DeleteTimeKeepingJob();
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = ParallelRun.class.getClassLoader()
					.getResourceAsStream(
							"ovirt_engine_dwh/parallelrun_3_2/contexts/"
...
/************************************************************************************************
 * 122752 characters generated by Talend Open Studio for Data Integration on the
