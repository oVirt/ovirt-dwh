...
//
// ============================================================================
package ovirt_engine_dwh.hostconfigcheck_3_3;
	...
	public void tJDBCInput_1Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String dbquery_tJDBCInput_1 = "SELECT upper(cast(host_id as char(36))) as host_join_id,  		memory_size_mb,   		swap_size_mb,  		cpu_model,   		number_of_cores,         number_of_sockets,         cpu_speed_mh,  		host_os,   		kernel_version,   		kvm_version,   		vdsm_version  FROM v3_3_latest_configuration_hosts";
	...
	public void tJDBCInput_3Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String dbquery_tJDBCInput_3 = "SELECT history_id, upper(cast(cluster_id as char(36))) as cluster_join_id  FROM  v3_3_latest_configuration_clusters";
		...
		try {
			...
			java.io.InputStream inContext = HostConfigCheck.class
					.getClassLoader().getResourceAsStream(
							"ovirt_engine_dwh/hostconfigcheck_3_3/contexts/"
