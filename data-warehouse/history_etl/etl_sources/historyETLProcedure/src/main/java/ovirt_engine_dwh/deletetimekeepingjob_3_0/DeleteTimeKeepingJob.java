...
//
// ============================================================================
package ovirt_engine_dwh.deletetimekeepingjob_3_0;
	...
	public void tRunJob_2Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				ovirt_engine_dwh.historydelete_3_0.HistoryDelete childJob_tRunJob_2 = new ovirt_engine_dwh.historydelete_3_0.HistoryDelete();
		...
		try {
			...
			java.io.InputStream inContext = DeleteTimeKeepingJob.class
					.getClassLoader().getResourceAsStream(
							"ovirt_engine_dwh/deletetimekeepingjob_3_0/contexts/"
			...
			if (isDefaultContext && inContext == null) {
				...
				try {
					context.deleteMore = Integer.parseInt(context
							.getProperty("deleteMore"));
...
/************************************************************************************************
 * 188523 characters generated by Talend Open Studio for Data Integration on the
 * May 23, 2012 5:04:57 PM IDT
 ************************************************************************************************/
