	...
	public void tJDBCInput_2Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String dbquery_tJDBCInput_2 = "SELECT 'deleteMore', '1'  FROM vm_disk_samples_history  WHERE history_datetime < '"
...
/************************************************************************************************
 * 87262 characters generated by Talend Open Studio for Data Integration on the
 * March 12, 2012 3:16:01 PM IST
 ************************************************************************************************/
