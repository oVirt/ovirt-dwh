...
//
// ============================================================================
package ovirt_engine_dwh.deletetimekeepingjob_3_1;
	...
	public void tRunJob_2Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				ovirt_engine_dwh.historydelete_3_1.HistoryDelete childJob_tRunJob_2 = new ovirt_engine_dwh.historydelete_3_1.HistoryDelete();
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				while (rs_tJDBCInput_9.next()) {
					...
					if (colQtyInRs_tJDBCInput_9 < 1) {
						...
						tmpContent_tJDBCInput_9 = rs_tJDBCInput_9.getString(1);
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				while (rs_tJDBCInput_8.next()) {
					...
					if (colQtyInRs_tJDBCInput_8 < 1) {
						...
						tmpContent_tJDBCInput_8 = rs_tJDBCInput_8.getString(1);
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				while (rs_tJDBCInput_7.next()) {
					...
					if (colQtyInRs_tJDBCInput_7 < 1) {
						...
						tmpContent_tJDBCInput_7 = rs_tJDBCInput_7.getString(1);
					...
					if (colQtyInRs_tJDBCInput_7 < 2) {
						...
						tmpContent_tJDBCInput_7 = rs_tJDBCInput_7.getString(2);
						if (tmpContent_tJDBCInput_7 != null) {
	...
	public void tSleep_2Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				Thread.sleep((context.deleteMore == 0 ? ((Long) globalMap
						.get("tChronometerStop_1_DURATION")) >= 86400000L ? 0
						: (86400000L - ((Long) globalMap
		...
		try {
			...
			java.io.InputStream inContext = DeleteTimeKeepingJob.class
					.getClassLoader().getResourceAsStream(
							"ovirt_engine_dwh/deletetimekeepingjob_3_1/contexts/"
...
/************************************************************************************************
 * 188823 characters generated by Talend Open Studio for Data Integration on the
 * June 17, 2012 6:23:12 PM IDT
 ************************************************************************************************/
