...
//
// ============================================================================
package ovirt_engine_dwh.samplerunjobs_3_0;
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				ovirt_engine_dwh.configurationsync_3_0.ConfigurationSync childJob_tRunJob_1 = new ovirt_engine_dwh.configurationsync_3_0.ConfigurationSync();
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				parentContextMap_tRunJob_6.put("ovirtEngineDbUser",
						context.ovirtEngineDbUser);
				parentContextMap_tRunJob_6.put("ovirtEngineHistoryDbDriverClass",
						context.ovirtEngineHistoryDbDriverClass);
				parentContextMap_tRunJob_6.put("ovirtEngineHistoryDbJdbcConnection",
						context.ovirtEngineHistoryDbJdbcConnection);
				...
				ovirt_engine_dwh.hostconfigcheck_3_0.HostConfigCheck childJob_tRunJob_6 = new ovirt_engine_dwh.hostconfigcheck_3_0.HostConfigCheck();
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				parentContextMap_tRunJob_5.put("ovirtEngineDbUser",
						context.ovirtEngineDbUser);
				parentContextMap_tRunJob_5.put("ovirtEngineHistoryDbDriverClass",
						context.ovirtEngineHistoryDbDriverClass);
				parentContextMap_tRunJob_5.put("ovirtEngineHistoryDbJdbcConnection",
						context.ovirtEngineHistoryDbJdbcConnection);
				...
				ovirt_engine_dwh.statisticssync_3_0.StatisticsSync childJob_tRunJob_5 = new ovirt_engine_dwh.statisticssync_3_0.StatisticsSync();
		...
		try {
			...
			java.io.InputStream inContext = SampleRunJobs.class
					.getClassLoader().getResourceAsStream(
							"ovirt_engine_dwh/samplerunjobs_3_0/contexts/"
...
/************************************************************************************************
 * 60457 characters generated by Talend Open Studio for Data Integration on the
