...
//
// ============================================================================
package ovirt_engine_dwh.statisticssync_3_2;
...
public class StatisticsSync implements TalendJob {
	...
	public static class datacenter_historyStruct implements
			routines.system.IPersistableRow<datacenter_historyStruct> {
		 ...
		 * Compare keys
		 */
		public int compareTo(datacenter_historyStruct other) {
	...
	public static class row9Struct implements
		...
		public Integer datacenter_status;

		public Integer getDatacenter_status() {
			return this.datacenter_status;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock) {
				...
				try {
					...
					this.datacenter_status = readInteger(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeInteger(this.datacenter_status, dos);
	...
	public void tJDBCInput_2Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				datacenter_historyStruct datacenter_history = new datacenter_historyStruct();
				...
				datacenter_historyStruct datacenter_history_tmp = new datacenter_historyStruct();
				// ###############################
				...
				while (rs_tJDBCInput_2.next()) {
					...
					if (colQtyInRs_tJDBCInput_2 < 1) {
						...
						if (rs_tJDBCInput_2.getObject(1) != null) {
							row9.datacenter_id = rs_tJDBCInput_2.getObject(1);
						} else {
							row9.datacenter_id = null;
						}
					...
					if (colQtyInRs_tJDBCInput_2 < 2) {
						...
						tmpContent_tJDBCInput_2 = rs_tJDBCInput_2.getString(2);
					...
					if (colQtyInRs_tJDBCInput_2 < 3) {
						...
						if (rs_tJDBCInput_2.getObject(3) != null) {
							row9.datacenter_status = rs_tJDBCInput_2.getInt(3);
						} else {
							row9.datacenter_status = null;
						}
			...
			globalMap.put("tHash_Lookup_row41", null);
	...
	public void tJDBCInput_1Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				start_Hash.put("tAdvancedHash_row41", System
						.currentTimeMillis());
				...
				// outputs:(row41,row41) | target node:tAdvancedHash_row41 -
				// inputs:(row41) outputs:()
				// linked node: tMap_1 - inputs:(row9,row41)
				// outputs:(datacenter_history)
				...
				String dbquery_tJDBCInput_1 = "SELECT history_id, upper(cast(datacenter_id as char(36))) as datacenter_join_id  FROM  v3_2_latest_configuration_datacenters";
				...
				while (rs_tJDBCInput_1.next()) {
					...
					if (colQtyInRs_tJDBCInput_1 < 1) {
						...
						if (rs_tJDBCInput_1.getObject(1) != null) {
							row41.history_id = rs_tJDBCInput_1.getInt(1);
						} else {
							row41.history_id = null;
						}
	...
	public void tJDBCInput_4Process(
		...
		try {
			...
			globalMap.put("tHash_Lookup_row43", null);
	...
	public void tJDBCInput_3Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				start_Hash.put("tAdvancedHash_row43", System
						.currentTimeMillis());
				...
				String dbquery_tJDBCInput_3 = "SELECT history_id, upper(cast(storage_domain_id as char(36))) as storage_domain_join_id  FROM  v3_2_latest_configuration_storage_domains";
				...
				while (rs_tJDBCInput_3.next()) {
					...
					if (colQtyInRs_tJDBCInput_3 < 2) {
						...
						tmpContent_tJDBCInput_3 = rs_tJDBCInput_3.getString(2);
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String insert_tJDBCOutput_3 = "INSERT INTO "
						...
						+ " (history_datetime,host_id,host_status,minutes_in_status,memory_usage_percent,cpu_usage_percent,ksm_cpu_percent,active_vms,total_vms,total_vms_vcpus,cpu_load,system_cpu_usage_percent,user_cpu_usage_percent,swap_used_mb,host_configuration_version) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
				...
				String dbquery_tJDBCInput_5 = "SELECT     host_id,    upper(cast(host_id as char(36))) as host_join_id,    host_status,     memory_usage_percent,     cpu_usage_percent,     ksm_cpu_percent,     cpu_load,     system_cpu_usage_percent,     user_cpu_usage_percent,     swap_used_mb,     vm_active,     total_vms,     total_vms_vcpus  FROM dwh_host_history_view";
				...
				while (rs_tJDBCInput_5.next()) {
					...
					if (colQtyInRs_tJDBCInput_5 < 2) {
						...
						tmpContent_tJDBCInput_5 = rs_tJDBCInput_5.getString(2);
					...
					if (colQtyInRs_tJDBCInput_5 < 6) {
						...
						if (rs_tJDBCInput_5.getObject(6) != null) {
							row10.ksm_cpu_percent = rs_tJDBCInput_5.getShort(6);
						} else {
							row10.ksm_cpu_percent = null;
						}
					...
					if (colQtyInRs_tJDBCInput_5 < 7) {
						...
						if (rs_tJDBCInput_5.getObject(7) != null) {
							row10.cpu_load = rs_tJDBCInput_5.getInt(7);
						} else {
							row10.cpu_load = null;
						}
					...
					if (colQtyInRs_tJDBCInput_5 < 10) {
						...
						if (rs_tJDBCInput_5.getObject(10) != null) {
							row10.swap_used_mb = rs_tJDBCInput_5.getInt(10);
						} else {
							row10.swap_used_mb = null;
						}
					...
					if (colQtyInRs_tJDBCInput_5 < 11) {
						...
						if (rs_tJDBCInput_5.getObject(11) != null) {
							row10.vm_active = rs_tJDBCInput_5.getShort(11);
						} else {
							row10.vm_active = null;
						}
					...
					if (colQtyInRs_tJDBCInput_5 < 12) {
						...
						if (rs_tJDBCInput_5.getObject(12) != null) {
							row10.total_vms = rs_tJDBCInput_5.getShort(12);
						} else {
							row10.total_vms = null;
						}
					...
					if (colQtyInRs_tJDBCInput_5 < 13) {
						...
						if (rs_tJDBCInput_5.getObject(13) != null) {
							row10.total_vms_vcpus = rs_tJDBCInput_5.getInt(13);
						} else {
							row10.total_vms_vcpus = null;
						}
					...
					row10.host_status != 0
						...
						if (host_history != null) {
							...
							if (host_history.system_cpu_usage_percent == null) {
								...
								pstmt_tJDBCOutput_3.setShort(12,
			...
			globalMap.put("tHash_Lookup_row42", null);
	...
	public void tJDBCInput_6Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				start_Hash.put("tAdvancedHash_row42", System
						.currentTimeMillis());
				...
				String dbquery_tJDBCInput_6 = "SELECT history_id, upper(cast(host_id as char(36))) as host_join_id  FROM v3_2_latest_configuration_hosts";
	...
	public void tJDBCInput_8Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				while (rs_tJDBCInput_8.next()) {
					...
					if (colQtyInRs_tJDBCInput_8 < 2) {
						...
						tmpContent_tJDBCInput_8 = rs_tJDBCInput_8.getString(2);
			...
			globalMap.put("tHash_Lookup_row45", null);
	...
	public void tJDBCInput_13Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				start_Hash.put("tAdvancedHash_row45", System
						.currentTimeMillis());
				...
				String dbquery_tJDBCInput_13 = "SELECT history_id, upper(cast(host_interface_id as char(36))) as host_interface_join_id  FROM v3_2_latest_configuration_hosts_interfaces";
	...
	public void tJDBCInput_10Process(
		...
		try {
			...
			globalMap.put("tHash_Lookup_row47", null);

			// free memory for "tMap_5"
			globalMap.put("tHash_Lookup_row48", null);
	...
	public void tJDBCInput_9Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				start_Hash.put("tAdvancedHash_row47", System
						.currentTimeMillis());
				...
				String dbquery_tJDBCInput_9 = "SELECT history_id, upper(cast(vm_id as char(36))) as vm_join_id  FROM  v3_2_latest_configuration_vms";
				...
				while (rs_tJDBCInput_9.next()) {
					...
					if (colQtyInRs_tJDBCInput_9 < 2) {
						...
						tmpContent_tJDBCInput_9 = rs_tJDBCInput_9.getString(2);
	...
	public void tJDBCInput_14Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				start_Hash.put("tAdvancedHash_row48", System
						.currentTimeMillis());
				...
				String dbquery_tJDBCInput_14 = "SELECT history_id, upper(cast(host_id as char(36))) as host_join_id  FROM v3_2_latest_configuration_hosts";
	...
	public void tJDBCInput_12Process(
		...
		try {
				...
				while (rs_tJDBCInput_12.next()) {
					...
					if (vinterface_history != null) {
						...
						if (vinterface_history.history_datetime != null) {
							pstmt_tJDBCOutput_6.setTimestamp(1,
									new java.sql.Timestamp(
			...
			globalMap.put("tHash_Lookup_row50", null);
	...
	public void tJDBCInput_15Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				start_Hash.put("tAdvancedHash_row50", System
						.currentTimeMillis());
				...
				String dbquery_tJDBCInput_15 = "SELECT history_id, upper(cast(vm_interface_id as char(36))) as vm_interface_join_id  FROM  v3_2_latest_configuration_vms_interfaces";
				...
				while (rs_tJDBCInput_18.next()) {
					...
					if (colQtyInRs_tJDBCInput_18 < 4) {
						...
						if (rs_tJDBCInput_18.getObject(4) != null) {
							row1.vm_disk_status = rs_tJDBCInput_18.getShort(4);
						} else {
							row1.vm_disk_status = null;
						}
					...
					if (vm_disk_history != null) {
						...
						if (vm_disk_history.history_datetime != null) {
							pstmt_tJDBCOutput_7.setTimestamp(1,
									new java.sql.Timestamp(
	...
	public void tJDBCInput_20Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String dbquery_tJDBCInput_20 = "SELECT history_id, upper(cast(vm_disk_id as char(36))) as vm_disk_join_id  FROM  v3_2_latest_configuration_vms_disks";
				...
				while (rs_tJDBCInput_21.next()) {
					...
					if (colQtyInRs_tJDBCInput_21 < 2) {
						...
						try {
							...
							date_tJDBCInput_21 = rs_tJDBCInput_21.getDate(2);
						}
		...
		try {
			...
			java.io.InputStream inContext = StatisticsSync.class
					.getClassLoader().getResourceAsStream(
							"ovirt_engine_dwh/statisticssync_3_2/contexts/"
...
/************************************************************************************************
 * 441168 characters generated by Talend Open Studio for Data Integration on the
 * November 19, 2012 4:23:08 PM IST
 ************************************************************************************************/
