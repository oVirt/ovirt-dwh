...
//
// ============================================================================
package ovirt_engine_dwh.samplerunjobs_3_3;
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				ovirt_engine_dwh.configurationsync_3_3.ConfigurationSync childJob_tRunJob_1 = new ovirt_engine_dwh.configurationsync_3_3.ConfigurationSync();
	...
	public void tRunJob_6Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				ovirt_engine_dwh.hostconfigcheck_3_3.HostConfigCheck childJob_tRunJob_6 = new ovirt_engine_dwh.hostconfigcheck_3_3.HostConfigCheck();
	...
	public void tRunJob_5Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				ovirt_engine_dwh.statisticssync_3_3.StatisticsSync childJob_tRunJob_5 = new ovirt_engine_dwh.statisticssync_3_3.StatisticsSync();
		...
		try {
			...
			java.io.InputStream inContext = SampleRunJobs.class
					.getClassLoader().getResourceAsStream(
							"ovirt_engine_dwh/samplerunjobs_3_3/contexts/"
...
/************************************************************************************************
 * 62259 characters generated by Talend Open Studio for Data Integration on the
