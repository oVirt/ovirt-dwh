...
//
// ============================================================================
package ovirt_engine_dwh.aggregationtohourly_3_2;
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				while (rs_tJDBCInput_4.next()) {
					...
					if (colQtyInRs_tJDBCInput_4 < 10) {
						...
						tmpContent_tJDBCInput_4 = rs_tJDBCInput_4.getString(10);
					...
					if (colQtyInRs_tJDBCInput_4 < 11) {
						...
						tmpContent_tJDBCInput_4 = rs_tJDBCInput_4.getString(11);
						if (tmpContent_tJDBCInput_4 != null) {
		...
		try {
			...
			java.io.InputStream inContext = AggregationToHourly.class
					.getClassLoader().getResourceAsStream(
							"ovirt_engine_dwh/aggregationtohourly_3_2/contexts/"
...
/************************************************************************************************
 * 679517 characters generated by Talend Open Studio for Data Integration on the
 * January 2, 2013 1:56:55 PM IST
 ************************************************************************************************/
