...
//
// ============================================================================
package ovirt_engine_dwh.historyetl_3_0;
	...
	public void tRunJob_4Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				parentContextMap_tRunJob_4.put("ovirtEngineHistoryDbDriverClass",
						context.ovirtEngineHistoryDbDriverClass);
				parentContextMap_tRunJob_4.put("ovirtEngineHistoryDbJdbcConnection",
				...
				ovirt_engine_dwh.parallelrun_3_0.ParallelRun childJob_tRunJob_4 = new ovirt_engine_dwh.parallelrun_3_0.ParallelRun();
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				java.io.File file_tFileDelete_1 = new java.io.File(
						"/usr/share/ovirt-engine-dwh/etl/kill");
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				class Util_tWaitForFile_1 {
					...
					java.util.List<java.io.File> getFiles() {
						String directoryt = "/usr/share/ovirt-engine-dwh/etl";
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				parentContextMap_tRunJob_2.put("ovirtEngineHistoryDbDriverClass",
						context.ovirtEngineHistoryDbDriverClass);
				parentContextMap_tRunJob_2.put("ovirtEngineHistoryDbJdbcConnection",
						context.ovirtEngineHistoryDbJdbcConnection);
				...
				ovirt_engine_dwh.minimalversioncheck_3_0.MinimalVersionCheck childJob_tRunJob_2 = new ovirt_engine_dwh.minimalversioncheck_3_0.MinimalVersionCheck();
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				class tRowGenerator_4Randomizer {
					...
					public String getRandommessage() {
						...
						return "oVirt Engine Portal is not available. Please check your ETL configuration.";
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = HistoryETL.class.getClassLoader()
					.getResourceAsStream(
							"ovirt_engine_dwh/historyetl_3_0/contexts/" + contextStr
									+ ".properties");
			if (isDefaultContext && inContext == null) {
				...
				try {
					context.timeBetweenErrorEvents = Long.parseLong(context
...
/************************************************************************************************
 * 226779 characters generated by Talend Open Studio for Data Integration on the
 * April 15, 2012 4:05:05 PM IDT
 ************************************************************************************************/
