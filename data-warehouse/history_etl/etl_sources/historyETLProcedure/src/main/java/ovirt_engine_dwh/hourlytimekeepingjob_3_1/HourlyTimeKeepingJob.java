...
//
// ============================================================================
package ovirt_engine_dwh.hourlytimekeepingjob_3_1;
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				ovirt_engine_dwh.aggregationtohourly_3_1.AggregationToHourly childJob_tRunJob_1 = new ovirt_engine_dwh.aggregationtohourly_3_1.AggregationToHourly();
		...
		try {
			...
			java.io.InputStream inContext = HourlyTimeKeepingJob.class
					.getClassLoader().getResourceAsStream(
							"ovirt_engine_dwh/hourlytimekeepingjob_3_1/contexts/"
...
/************************************************************************************************
 * 69485 characters generated by Talend Open Studio for Data Integration on the
 * October 18, 2012 6:06:19 PM IST
 ************************************************************************************************/
