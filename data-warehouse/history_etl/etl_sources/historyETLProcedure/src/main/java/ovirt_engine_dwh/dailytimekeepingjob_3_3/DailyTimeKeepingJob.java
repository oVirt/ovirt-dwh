...
//
// ============================================================================
package ovirt_engine_dwh.dailytimekeepingjob_3_3;
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				ovirt_engine_dwh.aggregationtodaily_3_3.AggregationToDaily childJob_tRunJob_1 = new ovirt_engine_dwh.aggregationtodaily_3_3.AggregationToDaily();
		...
		try {
			...
			java.io.InputStream inContext = DailyTimeKeepingJob.class
					.getClassLoader().getResourceAsStream(
							"ovirt_engine_dwh/dailytimekeepingjob_3_3/contexts/"
