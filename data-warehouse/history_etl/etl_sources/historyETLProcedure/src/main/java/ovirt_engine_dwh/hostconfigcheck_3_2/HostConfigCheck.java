...
//
// ============================================================================
package ovirt_engine_dwh.hostconfigcheck_3_2;
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				while (rs_tJDBCInput_2.next()) {
					...
					if (colQtyInRs_tJDBCInput_2 < 8) {
						...
						if (tmpContent_tJDBCInput_2 != null) {
							row2.fqdn_or_ip = tmpContent_tJDBCInput_2;
						} else {
							row2.fqdn_or_ip = null;
						}
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				while (rs_tJDBCInput_5.next()) {
					...
					if (colQtyInRs_tJDBCInput_5 < 3) {
						...
						try {
							date_tJDBCInput_5 = rs_tJDBCInput_5.getTimestamp(3);
						} catch (Exception e) {
	...
	public void tJDBCInput_1Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String dbquery_tJDBCInput_1 = "SELECT upper(cast(host_id as char(36))) as host_join_id,  		memory_size_mb,   		swap_size_mb,  		cpu_model,   		number_of_cores,         number_of_sockets,         cpu_speed_mh,  		host_os,   		kernel_version,   		kvm_version,   		vdsm_version  FROM v3_2_latest_configuration_hosts";
	...
	public void tJDBCInput_3Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String dbquery_tJDBCInput_3 = "SELECT history_id, upper(cast(cluster_id as char(36))) as cluster_join_id  FROM  v3_2_latest_configuration_clusters";
		...
		try {
			...
			java.io.InputStream inContext = HostConfigCheck.class
					.getClassLoader().getResourceAsStream(
							"ovirt_engine_dwh/hostconfigcheck_3_2/contexts/"
...
/************************************************************************************************
 * 184416 characters generated by Talend Open Studio for Data Integration on the
 * November 19, 2012 4:23:07 PM IST
 ************************************************************************************************/
